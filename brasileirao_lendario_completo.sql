...
-- TITULARES
INSERT INTO players(team_id,jersey,name,pos_primary,pos_secondary,overall,is_starter,notes) VALUES (10,1,'Falcão','VOL','MC',95,1,'O Rei de Roma. Tecnica inacreditavel, visao impecavel e elegancia incomparavel.');
INSERT INTO players(team_id,jersey,name,pos_primary,pos_secondary,overall,is_starter,notes) VALUES (10,2,'Figueroa','ZAG',NULL,96,1,'Don Elias. Zagueiro lendario do futebol sul-americano e autor do Gol Iluminado na final.');
INSERT INTO players(team_id,jersey,name,pos_primary,pos_secondary,overall,is_starter,notes) VALUES (10,3,'Carpegiani','MC','MEI',91,1,'Meio-campista cerebral de muita visao de jogo e qualidade extrema nos passes.');
INSERT INTO players(team_id,jersey,name,pos_primary,pos_secondary,overall,is_starter,notes) VALUES (10,4,'Manga','GOL',NULL,90,1,'Uma lenda sob as traves, elastico, seguro e de carater vencedor místico.');
INSERT INTO players(team_id,jersey,name,pos_primary,pos_secondary,overall,is_starter,notes) VALUES (10,5,'Lula','PE','ME',87,1,'Ponta esquerda habilidoso, velocissimo e de drible facil.');
INSERT INTO players(team_id,jersey,name,pos_primary,pos_secondary,overall,is_starter,notes) VALUES (10,6,'Valdomiro','PD','MD',88,1,'Ponta direita de forca, cruzamentos cirurgicos e heroi das bolas paradas.');
INSERT INTO players(team_id,jersey,name,pos_primary,pos_secondary,overall,is_starter,notes) VALUES (10,7,'Flávio Minuano','ATA',NULL,87,1,'Grande centroavante artilheiro, faro de gol e definicao cirurgica na area.');
INSERT INTO players(team_id,jersey,name,pos_primary,pos_secondary,overall,is_starter,notes) VALUES (10,8,'Caçapava','VOL','MC',85,1,'O esteio de contencao defensiva no meio-campo, liberando Falcao e Carpegiani.');
INSERT INTO players(team_id,jersey,name,pos_primary,pos_secondary,overall,is_starter,notes) VALUES (10,9,'Vacaria','LE',NULL,84,1,'Lateral de muita seguranca defensiva e excelente cruzador.');
INSERT INTO players(team_id,jersey,name,pos_primary,pos_secondary,overall,is_starter,notes) VALUES (10,10,'Hermínio','ZAG',NULL,83,1,'Zagueiro seguro que complementava com precisao o brilhantismo de Figueroa.');
INSERT INTO players(team_id,jersey,name,pos_primary,pos_secondary,overall,is_starter,notes) VALUES (10,11,'Valdir','LD',NULL,83,1,'Lateral direito muito firme e eficiente nas coberturas taticas.');

-- RESERVAS E ROTACAO
INSERT INTO players(team_id,jersey,name,pos_primary,pos_secondary,overall,is_starter,notes) VALUES (10,12,'Batista','VOL','MC',82,0,'Jovem volante de muita tecnica e que seria titular incontestavel logo depois.');
INSERT INTO players(team_id,jersey,name,pos_primary,pos_secondary,overall,is_starter,notes) VALUES (10,13,'Jair','MEI','MC',81,0,'Meia-atacante de excelente conducao e otimo drible.');
INSERT INTO players(team_id,jersey,name,pos_primary,pos_secondary,overall,is_starter,notes) VALUES (10,14,'Cláudio Duarte','LD','ZAG',78,0,'Curinga defensivo muito solido quando acionado.');
INSERT INTO players(team_id,jersey,name,pos_primary,pos_secondary,overall,is_starter,notes) VALUES (10,15,'Ramon','ATA','MD',77,0,'Centroavante de area reserva.');
INSERT INTO players(team_id,jersey,name,pos_primary,pos_secondary,overall,is_starter,notes) VALUES (10,16,'Chico Spina','PD','ATA',78,0,'Atacante veloz que entrava para quebrar linhas de marcacao.');
INSERT INTO players(team_id,jersey,name,pos_primary,pos_secondary,overall,is_starter,notes) VALUES (10,17,'Schneider','GOL',NULL,76,0,'Goleiro reserva de Manga.');
INSERT INTO players(team_id,jersey,name,pos_primary,pos_secondary,overall,is_starter,notes) VALUES (10,18,'Borjão','ATA',NULL,75,0,'Centroavante de oficio suplente.');
INSERT INTO players(team_id,jersey,name,pos_primary,pos_secondary,overall,is_starter,notes) VALUES (10,19,'Escurinho','ATA','MEI',79,0,'O reserva de ouro definitivo. Entrava de centroavante para resolver no jogo aereo.');
INSERT INTO players(team_id,jersey,name,pos_primary,pos_secondary,overall,is_starter,notes) VALUES (10,20,'Edinho','LE','ME',74,0,'Reserva da lateral esquerda.');
