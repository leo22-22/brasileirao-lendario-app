...
const TEAMS = [
  ...
  {
    id: 'saopaulo2026', club: 'Sao Paulo', year: 2026, label: 'Sao Paulo 2026 (Era Crespo)', coach: 'Hernan Crespo',
    colors: { p: '#C8102E', s: '#000000' },
    players: [
      { name: 'Rafael', pos: ['GOL'], ovr: 82 },
      { name: 'Cedric', pos: ['LD', 'MD'], ovr: 78 },
      { name: 'Arboleda', pos: ['ZAG'], ovr: 82 },
      { name: 'Alan Franco', pos: ['ZAG', 'VOL'], ovr: 80 },
      { name: 'Enzo Diaz', pos: ['LE', 'ME'], ovr: 78 },
      { name: 'Bobadilla', pos: ['VOL'], ovr: 79 },
      { name: 'Marcos Antonio', pos: ['MC', 'VOL'], ovr: 79 },
      { name: 'Oscar', pos: ['MEI', 'MC'], ovr: 82 },
      { name: 'Lucas Moura', pos: ['MEI', 'PD'], ovr: 84 },
      { name: 'Luciano', pos: ['ATA', 'MEI'], ovr: 81 },
      { name: 'Calleri', pos: ['ATA'], ovr: 83 },
      { name: 'Pablo Maia', pos: ['VOL', 'MC'], ovr: 80 },
      { name: 'Ferraresi', pos: ['ZAG'], ovr: 78 },
      { name: 'Wendell', pos: ['LE'], ovr: 78 },
      { name: 'Gonzalo Tapia', pos: ['ATA', 'PE'], ovr: 78 },
      { name: 'Ryan Francisco', pos: ['ATA'], ovr: 77 },
      { name: 'Lucas Ferreira', pos: ['PD', 'PE'], ovr: 77 },
      { name: 'Rafinha', pos: ['LD'], ovr: 76 },
      { name: 'Jandrei', pos: ['GOL'], ovr: 76 },
      { name: 'Sabino', pos: ['ZAG'], ovr: 77 },
    ]
  },
  {
