...
const TEAMS = [
  ...
  {
    id: 'gremio2026', club: 'Gremio', year: 2026, label: 'Gremio 2026', coach: 'Mano Menezes',
    colors: { p: '#0D80BF', s: '#000000' },
    players: [
      { name: 'Tiago Volpi', pos: ['GOL'], ovr: 79 },
      { name: 'Marcos Rocha', pos: ['LD', 'MD'], ovr: 77 },
      { name: 'Wagner Leonardo', pos: ['ZAG'], ovr: 79 },
      { name: 'Noriega', pos: ['ZAG', 'VOL'], ovr: 78 },
      { name: 'Marlon', pos: ['LE', 'ME'], ovr: 77 },
      { name: 'Dodi', pos: ['VOL'], ovr: 77 },
      { name: 'Villasanti', pos: ['VOL', 'MC'], ovr: 81 },
      { name: 'Cristaldo', pos: ['MEI', 'MC'], ovr: 80 },
      { name: 'Edenilson', pos: ['MC', 'MEI'], ovr: 78 },
      { name: 'Alysson', pos: ['PD', 'PE'], ovr: 78 },
      { name: 'Braithwaite', pos: ['ATA'], ovr: 81 },
      { name: 'Pavon', pos: ['PD', 'PE'], ovr: 78 },
      { name: 'Amuzu', pos: ['PE', 'ATA'], ovr: 77 },
      { name: 'Aravena', pos: ['PE', 'MEI'], ovr: 77 },
      { name: 'Monsalve', pos: ['MEI', 'MC'], ovr: 76 },
      { name: 'Joao Lucas', pos: ['LD'], ovr: 76 },
      { name: 'Jemerson', pos: ['ZAG'], ovr: 77 },
      { name: 'Andre Henrique', pos: ['ATA'], ovr: 75 },
      { name: 'Gabriel Grando', pos: ['GOL'], ovr: 76 },
      { name: 'Nathan Fernandes', pos: ['PE', 'PD'], ovr: 76 },
    ]
  },
  {
