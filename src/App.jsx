...
// (CLUB_LOGOS agora vem de ./data/club-logos.js — ver import no topo do arquivo)
...
// EmailLink, InfoPage, TeamsIndexPage e TeamDetailPage saíram daqui pra
// src/content/ContentPages.jsx (junto com CONTACT_EMAIL/INFO_TABS/
// INFO_ROUTES/HOW_TO_PLAY_STEPS/canonicalPathFor/canonicalTeamsPath/
// parseTeamsPathname, que foram pra src/data/info-content.js e
// src/lib/routes.js) — fica num bundle PRÓPRIO, separado do jogo, pra
// quem chega direto numa rota de conteúdo (/times, /times/{id},
// institucionais) não baixar o código do draft/simulador/multiplayer.
// Ver src/main.jsx (decide qual bundle carregar) e o import no topo
// deste arquivo (o jogo continua usando os MESMOS componentes pra
