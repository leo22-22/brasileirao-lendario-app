...
const TEAMS = [
  ...
  },
  {
    ...
    players: [
      ...
      { name: 'Khellven', pos: ['LD', 'MD'], ovr: 79 },
      { name: 'Gustavo Gomez', pos: ['ZAG'], ovr: 85 },
      { name: 'Murilo', pos: ['ZAG'], ovr: 82 },
      { name: 'Piquerez', pos: ['LE', 'ME'], ovr: 83 },
      { name: 'Anibal Moreno', pos: ['VOL'], ovr: 83 },
      { name: 'Lucas Evangelista', pos: ['MC', 'VOL'], ovr: 79 },
      { name: 'Andreas Pereira', pos: ['MEI', 'MC'], ovr: 82 },
      { name: 'Raphael Veiga', pos: ['MEI', 'ME'], ovr: 82 },
      { name: 'Flaco Lopez', pos: ['ATA'], ovr: 84 },
      { name: 'Vitor Roque', pos: ['ATA', 'PE'], ovr: 83 },
      { name: 'Facundo Torres', pos: ['PD', 'MEI'], ovr: 81 },
      { name: 'Ramon Sosa', pos: ['PE', 'ATA'], ovr: 80 },
      { name: 'Mauricio', pos: ['MEI', 'MC'], ovr: 81 },
      { name: 'Emiliano Martinez', pos: ['VOL', 'MC'], ovr: 78 },
      { name: 'Bruno Fuchs', pos: ['ZAG'], ovr: 79 },
      { name: 'Jefte', pos: ['LE', 'ME'], ovr: 78 },
      { name: 'Benedetti', pos: ['ZAG'], ovr: 77 },
      { name: 'Carlos Miguel', pos: ['GOL'], ovr: 79 },
      { name: 'Giay', pos: ['LD', 'ZAG'], ovr: 78 },
    ]
  },
  {
