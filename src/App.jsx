...
const TEAMS = [
  ...
  {
    id: 'fluminense2026', club: 'Fluminense', year: 2026, label: 'Fluminense 2026', coach: 'Luis Zubeldia',
    colors: { p: '#7A1921', s: '#006633' },
    players: [
      { name: 'Fabio', pos: ['GOL'], ovr: 84 },
      { name: 'Guga', pos: ['LD', 'MD'], ovr: 78 },
      { name: 'Thiago Silva', pos: ['ZAG'], ovr: 84 },
      { name: 'Freytes', pos: ['ZAG'], ovr: 78 },
      { name: 'Rene', pos: ['LE', 'ME'], ovr: 77 },
      { name: 'Hercules', pos: ['VOL', 'MC'], ovr: 80 },
      { name: 'Martinelli', pos: ['MC', 'VOL'], ovr: 80 },
      { name: 'Ganso', pos: ['MEI', 'MC'], ovr: 82 },
      { name: 'Canobbio', pos: ['PD', 'PE'], ovr: 80 },
      { name: 'Serna', pos: ['PE', 'PD'], ovr: 79 },
      { name: 'Cano', pos: ['ATA'], ovr: 80 },
      { name: 'Soteldo', pos: ['PE', 'MEI'], ovr: 79 },
      { name: 'Everaldo', pos: ['ATA'], ovr: 77 },
      { name: 'Nonato', pos: ['MC', 'MEI'], ovr: 78 },
      { name: 'Lima', pos: ['MEI', 'MD'], ovr: 78 },
      { name: 'Facundo Bernal', pos: ['VOL'], ovr: 76 },
      { name: 'Ignacio', pos: ['ZAG'], ovr: 77 },
      { name: 'Samuel Xavier', pos: ['LD'], ovr: 76 },
      { name: 'Vitor Eudes', pos: ['GOL'], ovr: 74 },
      { name: 'Riquelme', pos: ['PE', 'PD'], ovr: 76 },
    ]
  },
  {
