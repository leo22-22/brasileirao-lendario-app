...
// ============================================================
// DADOS: 200 times históricos do Brasileirão (1959-2026)
// ============================================================
const TEAMS = [
  {
  ...
  },
  {
    ...
    colors: { p: '#C8102E', s: '#000000' },
    players: [
      { name: 'Rossi', pos: ['GOL'], ovr: 81 },
      { name: 'Emerson Royal', pos: ['LD', 'MD'], ovr: 81 },
      { name: 'Leo Pereira', pos: ['ZAG'], ovr: 81 },
      { name: 'Leo Ortiz', pos: ['ZAG', 'VOL'], ovr: 80 },
      { name: 'Alex Sandro', pos: ['LE', 'ZAG'], ovr: 80 },
      { name: 'De la Cruz', pos: ['MC', 'MEI'], ovr: 84 },
      { name: 'Lucas Paqueta', pos: ['MC', 'MEI'], ovr: 84 },
      { name: 'Arrascaeta', pos: ['MEI', 'MC'], ovr: 83 },
      { name: 'Gonzalo Plata', pos: ['PD', 'MD', 'ATA'], ovr: 79 },
      { name: 'Pedro', pos: ['ATA'], ovr: 85 },
      { name: 'Samuel Lino', pos: ['PE', 'ME'], ovr: 82 },
      { name: 'Dyogo Alves', pos: ['GOL'], ovr: 71 },
      { name: 'Danilo', pos: ['LD', 'ZAG', 'MC'], ovr: 79 },
      { name: 'Guillermo Varela', pos: ['LD'], ovr: 76 },
      { name: 'Vitao', pos: ['ZAG'], ovr: 79 },
      { name: 'Ayrton Lucas', pos: ['LE', 'ME'], ovr: 78 },
      { name: 'Jorginho', pos: ['VOL', 'MC'], ovr: 81 },
      { name: 'Erick Pulgar', pos: ['VOL', 'MC'], ovr: 79 },
      { name: 'Everton Araujo', pos: ['VOL', 'MC'], ovr: 74 },
      { name: 'Saul', pos: ['MC', 'VOL'], ovr: 79 },
      { name: 'Bruno Henrique', pos: ['PE', 'ATA'], ovr: 81 },
    ]
  },
  {
    ...
    colors: { p: '#006437', s: '#ffffff' },
    players: [
      { name: 'Carlos Miguel', pos: ['GOL'], ovr: 79 },
      { name: 'Khellven', pos: ['LD', 'MD'], ovr: 75 },
      { name: 'Gustavo Gomez', pos: ['ZAG'], ovr: 80 },
      { name: 'Murilo Cerqueira', pos: ['ZAG'], ovr: 79 },
      { name: 'Piquerez', pos: ['LE', 'ME'], ovr: 79 },
      { name: 'Marlon Freitas', pos: ['VOL', 'MC'], ovr: 77 },
      { name: 'Andreas Pereira', pos: ['MC', 'MEI'], ovr: 79 },
      { name: 'Mauricio', pos: ['MEI', 'MC', 'PD'], ovr: 77 },
      { name: 'Jhon Arias', pos: ['PD', 'MEI', 'MD'], ovr: 81 },
      { name: 'Vitor Roque', pos: ['ATA', 'PE'], ovr: 80 },
      { name: 'Paulinho', pos: ['PE', 'MEI', 'PD'], ovr: 79 },
      { name: 'Marcelo Lomba', pos: ['GOL'], ovr: 72 },
      { name: 'Giay', pos: ['LD', 'VOL', 'MC'], ovr: 75 },
      { name: 'Alexander Barboza', pos: ['ZAG'], ovr: 76 },
      { name: 'Bruno Fuchs', pos: ['ZAG', 'VOL'], ovr: 74 },
      { name: 'Jefte', pos: ['LE', 'ME'], ovr: 72 },
      { name: 'Emiliano Martinez', pos: ['VOL', 'MC'], ovr: 75 },
      { name: 'Lucas Evangelista', pos: ['MC', 'MEI'], ovr: 75 },
      { name: 'Flaco Lopez', pos: ['ATA'], ovr: 78 },
      { name: 'Felipe Anderson', pos: ['PE', 'PD', 'MEI', 'ATA'], ovr: 78 },
      { name: 'Ramon Sosa', pos: ['PE', 'PD', 'ATA'], ovr: 76 },
    ]
  },
  {
    ...
    colors: { p: '#0033A0', s: '#ffffff' },
    players: [
      { name: 'Cassio Ramos', pos: ['GOL'], ovr: 79 },
      { name: 'Fagner', pos: ['LD', 'MD'], ovr: 78 },
      { name: 'Fabricio Bruno', pos: ['ZAG'], ovr: 81 },
      { name: 'Lucas Villalba', pos: ['ZAG', 'LE'], ovr: 78 },
      { name: 'Gabriel Rojas', pos: ['LE'], ovr: 76 },
      { name: 'Lucas Romero', pos: ['VOL', 'MC'], ovr: 78 },
      { name: 'Matheus Henrique', pos: ['MC', 'VOL'], ovr: 78 },
      { name: 'Matheus Pereira', pos: ['MEI', 'MC'], ovr: 84 },
      { name: 'Gabriel Pec', pos: ['PD', 'MD', 'PE'], ovr: 80 },
      { name: 'Kaio Jorge', pos: ['ATA'], ovr: 80 },
      { name: 'Wesley Gassova', pos: ['PE', 'ME', 'PD'], ovr: 77 },
      { name: 'Otavio Costa', pos: ['GOL'], ovr: 74 },
      { name: 'William Furtado', pos: ['LD', 'MD'], ovr: 76 },
      { name: 'Jonathan Jesus', pos: ['ZAG'], ovr: 76 },
      { name: 'Joao Marcelo', pos: ['ZAG'], ovr: 76 },
      { name: 'Fabrizio Peralta', pos: ['VOL', 'MC'], ovr: 75 },
      { name: 'Ze Lucas', pos: ['MC', 'VOL'], ovr: 74 },
      { name: 'Gerson', pos: ['MEI', 'MC', 'VOL'], ovr: 83 },
      { name: 'Keny Arroyo', pos: ['MEI', 'PE'], ovr: 74 },
      { name: 'Kaique Kenji', pos: ['PE', 'ATA', 'MD'], ovr: 75 },
    ]
  },
  {
  ...
  },
  {
    ...
    colors: { p: '#000000', s: '#ffffff' },
    players: [
      { name: 'Gabriel Batista', pos: ['GOL'], ovr: 78 },
      { name: 'Mateo Ponte', pos: ['LD', 'ZAG'], ovr: 76 },
      { name: 'Nahuel Ferraresi', pos: ['ZAG'], ovr: 78 },
      { name: 'Vitinho', pos: ['ZAG', 'LD'], ovr: 76 },
      { name: 'Alex Telles', pos: ['LE', 'ME'], ovr: 80 },
      { name: 'Danilo (ex-Nottingham)', pos: ['MC', 'VOL'], ovr: 81 },
      { name: 'Cristian Medina', pos: ['MC', 'MEI'], ovr: 80 },
      { name: 'Alvaro Montoro', pos: ['MEI', 'PE'], ovr: 79 },
      { name: 'Artur Victor', pos: ['PD', 'MD', 'ATA'], ovr: 80 },
      { name: 'Arthur Cabral', pos: ['ATA'], ovr: 80 },
      { name: 'Nathan Fernandes', pos: ['PE', 'PD'], ovr: 75 },
      { name: 'Warleson', pos: ['GOL'], ovr: 75 },
      { name: 'Lucas Monzon', pos: ['ZAG'], ovr: 73 },
      { name: 'Kaio', pos: ['ZAG'], ovr: 72 },
      { name: 'Caio Roque', pos: ['LE'], ovr: 72 },
      { name: 'Allan', pos: ['VOL', 'MC'], ovr: 76 },
      { name: 'Lucas Villalba', pos: ['MC', 'VOL', 'LE'], ovr: 76 },
      { name: 'Edenilson', pos: ['MC', 'VOL'], ovr: 75 },
      { name: 'Chris Ramos', pos: ['ATA'], ovr: 78 },
      { name: 'Junior Santos', pos: ['ATA', 'PD'], ovr: 77 },
    ]
  },
  {
    ...
    colors: { p: '#003399', s: '#C8102E' },
    players: [
      { name: 'Guido Herrera', pos: ['GOL'], ovr: 78 },
      { name: 'Roman Gomez', pos: ['LD', 'MD'], ovr: 74 },
      { name: 'Gabriel Xavier', pos: ['ZAG'], ovr: 79 },
      { name: 'Kanu', pos: ['ZAG'], ovr: 76 },
      { name: 'Luciano Juba', pos: ['LE', 'ME'], ovr: 78 },
      { name: 'Caio Alexandre', pos: ['VOL', 'MC'], ovr: 80 },
      { name: 'Jean Lucas', pos: ['MC', 'VOL'], ovr: 79 },
      { name: 'Cauly Oliveira', pos: ['MEI', 'MC'], ovr: 81 },
      { name: 'Ademir', pos: ['PD', 'MD'], ovr: 76 },
      { name: 'Alejo Veliz', pos: ['ATA'], ovr: 79 },
      { name: 'Erick Pulga', pos: ['PE', 'PD', 'ME'], ovr: 78 },
      { name: 'Ronaldo', pos: ['GOL'], ovr: 74 },
      { name: 'Santiago Ramos Mingo', pos: ['ZAG', 'LE'], ovr: 76 },
      { name: 'David Duarte', pos: ['ZAG'], ovr: 73 },
      { name: 'Iago Borduchi', pos: ['LE', 'ME'], ovr: 77 },
      { name: 'Nicolas Acevedo', pos: ['VOL', 'MC'], ovr: 76 },
      { name: 'Rodrigo Nestor', pos: ['MC', 'MEI', 'ME'], ovr: 77 },
      { name: 'Everton Ribeiro', pos: ['MEI', 'MC'], ovr: 80 },
      { name: 'Thaciano', pos: ['MEI', 'MC', 'ATA', 'PD'], ovr: 78 },
      { name: 'Willian Jose', pos: ['ATA'], ovr: 78 },
    ]
  },
  {
    ...
    colors: { p: '#7A1921', s: '#006633' },
    players: [
      { name: 'Fabio', pos: ['GOL'], ovr: 79 },
      { name: 'Samuel Xavier', pos: ['LD', 'MD'], ovr: 75 },
      { name: 'Thiago Silva', pos: ['ZAG'], ovr: 82 },
      { name: 'Igor Rabello', pos: ['ZAG'], ovr: 76 },
      { name: 'Guilherme Arana', pos: ['LE', 'ME'], ovr: 82 },
      { name: 'Hercules', pos: ['VOL', 'MC'], ovr: 79 },
      { name: 'Martinelli', pos: ['VOL', 'MC'], ovr: 77 },
      { name: 'Lucho Acosta', pos: ['MEI', 'MC', 'PE'], ovr: 81 },
      { name: 'Hulk', pos: ['ATA', 'PD'], ovr: 83 },
      { name: 'Yeferson Soteldo', pos: ['PE', 'MEI', 'PD'], ovr: 79 },
      { name: 'Kevin Serna', pos: ['PE', 'PD', 'ATA'], ovr: 77 },
      { name: 'Vitor Eudes', pos: ['GOL'], ovr: 72 },
      { name: 'Guga', pos: ['LD', 'LE'], ovr: 74 },
      { name: 'Ignacio', pos: ['ZAG'], ovr: 75 },
      { name: 'Freytes', pos: ['ZAG', 'LE'], ovr: 74 },
      { name: 'Jemmes', pos: ['ZAG'], ovr: 73 },
      { name: 'Gabriel Fuentes', pos: ['LE'], ovr: 74 },
      { name: 'Alisson (ex-Sao Paulo)', pos: ['MC', 'VOL'], ovr: 75 },
      { name: 'Gustavo Nonato', pos: ['MC', 'VOL'], ovr: 74 },
      { name: 'Ganso', pos: ['MEI', 'MC'], ovr: 80 },
      { name: 'John Kennedy', pos: ['ATA', 'PE'], ovr: 79 },
    ]
  },
  {
    ...
    colors: { p: '#C8102E', s: '#000000' },
    players: [
      { name: 'Rafael Pires', pos: ['GOL'], ovr: 79 },
      { name: 'Aurelio Buta', pos: ['LD', 'MD'], ovr: 76 },
      { name: 'Rafael Toloi', pos: ['ZAG', 'LD'], ovr: 77 },
      { name: 'Domingos Duarte', pos: ['ZAG'], ovr: 75 },
      { name: 'Iago Borduchi', pos: ['LE', 'ME'], ovr: 75 },
      { name: 'Pablo Maia', pos: ['VOL', 'MC'], ovr: 79 },
      { name: 'Marcos Antonio', pos: ['VOL', 'MC'], ovr: 76 },
      { name: 'Cauly', pos: ['MEI', 'MC'], ovr: 80 },
      { name: 'Artur', pos: ['PD', 'MD', 'ATA'], ovr: 79 },
      { name: 'Jonathan Calleri', pos: ['ATA'], ovr: 81 },
      { name: 'Victor Sa', pos: ['PE', 'PD', 'ME'], ovr: 76 },
      { name: 'Carlos Coronel', pos: ['GOL'], ovr: 74 },
      { name: 'Lucas Ramon', pos: ['LD', 'MD'], ovr: 74 },
      { name: 'Cedric Soares', pos: ['LD', 'MD'], ovr: 74 },
      { name: 'Sabino', pos: ['ZAG', 'LE'], ovr: 74 },
      { name: 'Wendell Borges', pos: ['LE', 'ME'], ovr: 75 },
      { name: 'Damian Bobadilla', pos: ['MC', 'VOL', 'MEI'], ovr: 75 },
      { name: 'Danielzinho', pos: ['MC', 'MEI'], ovr: 75 },
      { name: 'Lucas Moura', pos: ['MEI', 'PD', 'ATA'], ovr: 80 },
      { name: 'Luciano Neves', pos: ['ATA', 'MEI'], ovr: 78 },
      { name: 'Gonzalo Tapia', pos: ['ATA', 'PE'], ovr: 74 },
      { name: 'Ferreirinha', pos: ['PE', 'ME', 'PD'], ovr: 76 },
    ]
  },
  {
    ...
    players: [
      { name: 'Cleiton', pos: ['GOL'], ovr: 77 },
      { name: 'Andres Hurtado', pos: ['LD', 'MD'], ovr: 74 },
      { name: 'Alix Vinicius', pos: ['ZAG'], ovr: 76 },
      { name: 'Eduardo Santos', pos: ['ZAG'], ovr: 75 },
      { name: 'Juninho Capixaba', pos: ['LE', 'ME'], ovr: 77 },
      { name: 'Matheus Fernandes', pos: ['VOL', 'MC'], ovr: 76 },
      { name: 'Gabriel Girotto', pos: ['VOL', 'MC'], ovr: 75 },
      { name: 'Eric Ramires', pos: ['MC', 'VOL', 'MEI'], ovr: 76 },
      { name: 'Lucas Barbosa', pos: ['PD', 'MD', 'MEI', 'ATA'], ovr: 77 },
      { name: 'Isidro Pitta', pos: ['ATA'], ovr: 78 },
      { name: 'Henry Mosquera', pos: ['PE', 'PD'], ovr: 75 },
      { name: 'Tiago Volpi', pos: ['GOL'], ovr: 75 },
      { name: 'Agustin Sant Anna', pos: ['LD'], ovr: 74 },
      { name: 'Pedro Henrique', pos: ['ZAG'], ovr: 74 },
      { name: 'Gustavo Marques', pos: ['ZAG'], ovr: 73 },
      { name: 'Luan Candido', pos: ['LE', 'ZAG'], ovr: 76 },
      { name: 'Ignacio Sosa', pos: ['VOL', 'MC'], ovr: 73 },
      { name: 'Rodriguinho', pos: ['MC', 'MEI'], ovr: 74 },
      { name: 'Jose Maria Herrera', pos: ['PD', 'MD', 'ATA'], ovr: 74 },
      { name: 'Eduardo Sasha', pos: ['ATA', 'MEI'], ovr: 76 },
    ]
  },
  {
    ...
    colors: { p: '#000000', s: '#ffffff' },
    players: [
      { name: 'Hugo Souza', pos: ['GOL'], ovr: 81 },
      { name: 'Matheuzinho', pos: ['LD', 'MD'], ovr: 78 },
      { name: 'Andre Ramalho', pos: ['ZAG', 'VOL'], ovr: 80 },
      { name: 'Felix Torres', pos: ['ZAG'], ovr: 79 },
      { name: 'Fabrizio Angileri', pos: ['LE', 'ME'], ovr: 75 },
      { name: 'Raniele', pos: ['VOL', 'ZAG', 'MC'], ovr: 79 },
      { name: 'Breno Bidon', pos: ['MC', 'VOL', 'MEI'], ovr: 80 },
      { name: 'Rodrigo Garro', pos: ['MEI', 'MC'], ovr: 84 },
      { name: 'Labiad', pos: ['MEI', 'PE', 'PD'], ovr: 77 },
      { name: 'Kaio Cesar', pos: ['PD', 'MD', 'ATA'], ovr: 77 },
      { name: 'Memphis Depay', pos: ['ATA', 'PE', 'MEI'], ovr: 84 },
      { name: 'Matheus Donelli', pos: ['GOL'], ovr: 71 },
      { name: 'Pedro Milans', pos: ['LD', 'MD'], ovr: 72 },
      { name: 'Gabriel Paulista', pos: ['ZAG'], ovr: 79 },
      { name: 'Caca', pos: ['ZAG'], ovr: 76 },
      { name: 'Joao Pedro', pos: ['ZAG'], ovr: 69 },
      { name: 'Matheus Bidu', pos: ['LE', 'ME'], ovr: 75 },
      { name: 'Andre Garoto', pos: ['VOL', 'MC'], ovr: 78 },
      { name: 'Allan', pos: ['VOL', 'MC'], ovr: 78 },
      { name: 'Matheus Pereira', pos: ['VOL', 'MC'], ovr: 73 },
      { name: 'Jesse Lingard', pos: ['MEI', 'PE', 'PD'], ovr: 76 },
      { name: 'Andre Carrillo', pos: ['PD', 'MD', 'ATA'], ovr: 76 },
      { name: 'Yuri Alberto', pos: ['ATA'], ovr: 81 },
    ]
  },
  {
    ...
    colors: { p: '#0D80BF', s: '#000000' },
    players: [
      { name: 'Weverton', pos: ['GOL'], ovr: 80 },
      { name: 'Marcos Rocha', pos: ['LD', 'MD'], ovr: 76 },
      { name: 'Wagner Leonardo', pos: ['ZAG', 'LE'], ovr: 78 },
      { name: 'Fabian Balbuena', pos: ['ZAG'], ovr: 77 },
      { name: 'Marlon', pos: ['LE', 'ME'], ovr: 76 },
      { name: 'Mathias Villasanti', pos: ['VOL', 'MC'], ovr: 79 },
      { name: 'Arthur Melo', pos: ['MC', 'VOL'], ovr: 80 },
      { name: 'Franco Cristaldo', pos: ['MEI', 'MC'], ovr: 79 },
      { name: 'Tete', pos: ['PD', 'MD', 'PE'], ovr: 79 },
      { name: 'Martin Braithwaite', pos: ['ATA'], ovr: 79 },
      { name: 'Jovane Cabral', pos: ['PE', 'ME', 'MEI'], ovr: 76 },
      { name: 'Gabriel Grando', pos: ['GOL'], ovr: 72 },
      { name: 'Diego Caito', pos: ['LD', 'MD'], ovr: 71 },
      { name: 'Erick Noriega', pos: ['ZAG', 'VOL'], ovr: 75 },
      { name: 'Wallace', pos: ['ZAG'], ovr: 74 },
      { name: 'Danilo Barbosa', pos: ['VOL', 'MC', 'ZAG'], ovr: 75 },
      { name: 'Filip Krovinovic', pos: ['MC', 'MEI'], ovr: 77 },
      { name: 'Cristian Pavon', pos: ['PD', 'MD', 'PE'], ovr: 78 },
      { name: 'Carlos Vinicius', pos: ['ATA'], ovr: 78 },
      { name: 'Francis Amuzu', pos: ['PE', 'ME'], ovr: 75 },
    ]
  },
  {
  ...
  },
  {
    ...
    colors: { p: '#000000', s: '#ffffff' },
    players: [
      { name: 'Everson', pos: ['GOL'], ovr: 80 },
      { name: 'Angelo Preciado', pos: ['LD', 'MD'], ovr: 77 },
      { name: 'Lyanco', pos: ['ZAG', 'LD'], ovr: 78 },
      { name: 'Vitor Hugo (Zagueiro)', pos: ['ZAG'], ovr: 77 },
      { name: 'Renan Lodi', pos: ['LE', 'ME'], ovr: 80 },
      { name: 'Maycon Barberan', pos: ['VOL', 'MC'], ovr: 79 },
      { name: 'Fred Santos', pos: ['MC', 'VOL', 'MEI'], ovr: 79 },
      { name: 'Gustavo Scarpa', pos: ['MEI', 'MD', 'MC'], ovr: 82 },
      { name: 'Tomas Cuello', pos: ['PD', 'MD'], ovr: 77 },
      { name: 'Mateo Cassierra', pos: ['ATA'], ovr: 80 },
      { name: 'Alan Minda', pos: ['PE', 'MEI'], ovr: 76 },
      { name: 'Gabriel Delfim', pos: ['GOL'], ovr: 72 },
      { name: 'Natanael', pos: ['LD', 'MD'], ovr: 75 },
      { name: 'Ruan Tressoldi', pos: ['ZAG'], ovr: 76 },
      { name: 'Leo Duarte', pos: ['ZAG'], ovr: 76 },
      { name: 'Alan Franco', pos: ['VOL', 'MC'], ovr: 77 },
      { name: 'Kevin Castano', pos: ['VOL', 'MC'], ovr: 76 },
      { name: 'Victor Hugo (Meia)', pos: ['MC', 'MEI'], ovr: 76 },
      { name: 'Igor Gomes', pos: ['MC', 'MEI'], ovr: 75 },
      { name: 'Bernard', pos: ['MEI', 'PE', 'PD'], ovr: 78 },
      { name: 'Thiago Borbas', pos: ['ATA'], ovr: 77 },
    ]
  },
  {
    ...
    colors: { p: '#D2122E', s: '#ffffff' },
    players: [
      { name: 'Sergio Rochet', pos: ['GOL'], ovr: 81 },
      { name: 'Braian Aguirre', pos: ['LD', 'MD'], ovr: 76 },
      { name: 'Felix Torres', pos: ['ZAG'], ovr: 79 },
      { name: 'Guillermo Maripan', pos: ['ZAG'], ovr: 78 },
      { name: 'Alexandro Bernabei', pos: ['LE', 'ME'], ovr: 78 },
      { name: 'Rodrigo Villagra', pos: ['VOL', 'MC'], ovr: 77 },
      ...
      { name: 'Victor Gabriel', pos: ['ZAG'], ovr: 73 },
      { name: 'Matheus Bahia', pos: ['LE'], ovr: 74 },
      { name: 'Bruno Henrique', pos: ['MC', 'VOL'], ovr: 76 },
      { name: 'Alan Rodriguez', pos: ['MC', 'VOL'], ovr: 75 },
      { name: 'Niclas Eliasson', pos: ['MD', 'PD', 'ME'], ovr: 78 },
      { name: 'Calebe', pos: ['MEI', 'MC', 'PD'], ovr: 77 },
      { name: 'Alerrandro', pos: ['ATA'], ovr: 76 },
    ]
  },
  {
    ...
    colors: { p: '#000000', s: '#ffffff' },
    players: [
      { name: 'Gabriel Brazao', pos: ['GOL'], ovr: 81 },
      { name: 'Igor Vinicius', pos: ['LD', 'MD'], ovr: 77 },
      { name: 'Lucas Verissimo', pos: ['ZAG'], ovr: 78 },
      { name: 'Luan Peres', pos: ['ZAG', 'LE'], ovr: 78 },
      { name: 'Escobar', pos: ['LE', 'ZAG'], ovr: 76 },
      { name: 'Willian Arao', pos: ['VOL', 'ZAG', 'MC'], ovr: 79 },
      { name: 'Gabriel Bontempo', pos: ['MC', 'MEI'], ovr: 80 },
      { name: 'Rollheiser', pos: ['MEI', 'PD', 'MC'], ovr: 79 },
      { name: 'Gabigol', pos: ['ATA', 'PD'], ovr: 82 },
      { name: 'Neymar', pos: ['PE', 'MEI', 'ATA'], ovr: 86 },
      { name: 'Barreal', pos: ['PE', 'ME', 'MEI'], ovr: 78 },
      { name: 'Joao Paulo', pos: ['GOL'], ovr: 75 },
      { name: 'Diogenes', pos: ['GOL'], ovr: 68 },
      { name: 'Davizinho', pos: ['LD', 'MD'], ovr: 72 },
      { name: 'Joao Ananias', pos: ['ZAG'], ovr: 77 },
      { name: 'Joao Schmidt', pos: ['VOL', 'MC'], ovr: 77 },
      { name: 'Christian Oliva', pos: ['VOL', 'MC'], ovr: 75 },
      { name: 'Gabriel Menino', pos: ['MC', 'VOL', 'MD'], ovr: 76 },
      { name: 'Miguel Terceros', pos: ['MEI', 'PE', 'PD'], ovr: 74 },
    ]
  },
  {
    ...
    colors: { p: '#C8102E', s: '#000000' },
    players: [
      { name: 'Lucas Arcanjo', pos: ['GOL'], ovr: 79 },
      { name: 'Fabiano Souza', pos: ['LD', 'MD'], ovr: 74 },
      { name: 'Emanuel Britez', pos: ['ZAG', 'LD'], ovr: 77 },
      { name: 'Caca', pos: ['ZAG'], ovr: 76 },
      { name: 'Luan Candido', pos: ['LE', 'ZAG'], ovr: 77 },
      { name: 'Walace', pos: ['VOL', 'MC'], ovr: 78 },
      { name: 'Gabriel Baralhas', pos: ['VOL', 'MC'], ovr: 77 },
      { name: 'Matheuzinho', pos: ['MEI', 'PE', 'PD'], ovr: 79 },
      { name: 'Marinho', pos: ['PD', 'MD', 'ATA'], ovr: 78 },
      { name: 'Renato Kayzer', pos: ['ATA'], ovr: 77 },
      { name: 'Diego Tarzia', pos: ['PE', 'ME'], ovr: 75 },
      { name: 'Yuri Sena', pos: ['GOL'], ovr: 71 },
      { name: 'Mateusinho', pos: ['LD', 'MD'], ovr: 74 },
      { name: 'Riccieli', pos: ['ZAG'], ovr: 76 },
      { name: 'Camutanga', pos: ['ZAG'], ovr: 75 },
      { name: 'Ramon Ramos', pos: ['LE', 'ME'], ovr: 75 },
      { name: 'Caique Goncalves', pos: ['VOL', 'MC'], ovr: 75 },
      { name: 'Ze Vitor', pos: ['VOL', 'MC'], ovr: 74 },
      { name: 'Emmanuel Martinez', pos: ['MC', 'VOL', 'MEI'], ovr: 77 },
      { name: 'Tomas Pochettino', pos: ['MEI', 'MC'], ovr: 77 },
      { name: 'Rene', pos: ['ATA', 'PE'], ovr: 74 },
    ]
  },
  {
    ...
    colors: { p: '#C8102E', s: '#000000' },
    players: [
      { name: 'Santos', pos: ['GOL'], ovr: 76 },
      { name: 'Gaston Benavidez', pos: ['LD', 'MD'], ovr: 75 },
      { name: 'Juan Felipe Aguirre', pos: ['ZAG'], ovr: 75 },
      { name: 'Carlos Teran', pos: ['ZAG', 'LD'], ovr: 74 },
      { name: 'Lucas Esquivel', pos: ['LE', 'ZAG'], ovr: 75 },
      { name: 'Luiz Gustavo', pos: ['VOL', 'MC'], ovr: 75 },
      { name: 'Jadson', pos: ['VOL', 'MC', 'MD'], ovr: 74 },
      { name: 'Bruno Zapelli', pos: ['MEI', 'MC', 'PE'], ovr: 77 },
      { name: 'Agustin Canobbio', pos: ['PD', 'MD', 'PE'], ovr: 76 },
      { name: 'Kevin Viveros', pos: ['ATA', 'PD'], ovr: 82 },
      { name: 'Stiven Mendoza', pos: ['PE', 'PD', 'ATA'], ovr: 75 },
      { name: 'Mycael', pos: ['GOL'], ovr: 74 },
      { name: 'Gilberto Moraes', pos: ['LD', 'MD'], ovr: 74 },
      { name: 'Mateo Gamarra', pos: ['ZAG', 'VOL'], ovr: 73 },
      { name: 'Arthur Dias', pos: ['ZAG'], ovr: 72 },
      { name: 'Leo Derik', pos: ['LE'], ovr: 71 },
      { name: 'Juan Portilla', pos: ['VOL', 'MC'], ovr: 74 },
      { name: 'Felipinho', pos: ['VOL', 'MC', 'LE'], ovr: 73 },
      { name: 'Joao Cruz', pos: ['MEI', 'MC'], ovr: 74 },
      { name: 'Gonzalo Mastriani', pos: ['ATA'], ovr: 75 },
    ]
  },
  {
    ...
    colors: { p: '#006437', s: '#ffffff' },
    players: [
      { name: 'Pedro Morisco', pos: ['GOL'], ovr: 76 },
      { name: 'Tinga', pos: ['LD', 'ZAG', 'MD'], ovr: 75 },
      { name: 'Maicon', pos: ['ZAG'], ovr: 74 },
      { name: 'Jaci', pos: ['ZAG', 'VOL'], ovr: 73 },
      { name: 'Bruno Melo', pos: ['LE', 'ZAG'], ovr: 74 },
      { name: 'Sebastian Gomez', pos: ['VOL', 'MC'], ovr: 75 },
      { name: 'Thiago Santos', pos: ['VOL', 'ZAG'], ovr: 74 },
      { name: 'Josue', pos: ['MEI', 'MC'], ovr: 75 },
      { name: 'Lucas Ronier', pos: ['PD', 'MD', 'MEI'], ovr: 75 },
      { name: 'Pedro Rocha', pos: ['ATA', 'PE'], ovr: 75 },
      { name: 'Breno Lopes', pos: ['PE', 'ATA'], ovr: 75 },
      { name: 'Pedro Rangel', pos: ['GOL'], ovr: 72 },
      { name: 'JP Chermont', pos: ['LD', 'MD'], ovr: 74 },
      { name: 'Tiago Coser', pos: ['ZAG'], ovr: 72 },
      { name: 'Thalisson Gabriel', pos: ['ZAG'], ovr: 71 },
      { name: 'Rodrigo Moledo', pos: ['ZAG'], ovr: 70 },
      { name: 'Rodrigo Gelado', pos: ['LE', 'ME'], ovr: 71 },
      { name: 'Fernando Sobral', pos: ['MC', 'VOL', 'MD'], ovr: 74 },
      { name: 'Vini Paulista', pos: ['MC', 'MEI', 'VOL'], ovr: 72 },
      { name: 'Renato Marques', pos: ['ATA'], ovr: 72 },
      { name: 'Brian Ocampo', pos: ['PE', 'PD'], ovr: 74 },
    ]
  },
  {
...
const WHATS_NEW = [
  ...
  },
  {
    ...
    desc: 'O draft dobrou de novo: são 200 elencos e 4.000 jogadores. Entraram elencos que faltavam de eras passadas e também os elencos atuais (2026) dos 20 times que estão disputando o Brasileirão agora — dá pra sortear ou jogar direto com o time do ano. Com o dobro de times na roleta, cada draft fica ainda mais variado.',
  },
  {
    id: '2026-08-editor-formacao-livre',
    date: 'Agosto de 2026',
    title: 'Novidade: monte sua própria formação tática',
    desc: 'Além dos esquemas prontos, agora dá pra criar sua própria formação arrastando os jogadores no campo — o jogo calcula automaticamente as posições (ZAG, LD, VOL, MEI, PD, etc.) e mostra uma análise tática na hora, tipo "ataque forte, mas cuidado com o contra-ataque pelos lados". Tem marcação amarela mostrando o limite entre lateral e ponta, dá pra clicar numa bolinha pra trocar a posição dela na hora, e o jogo valida o mínimo de defensores e meio-campistas (e não deixa repetir 2 LD, 2 ME, 2 PD etc.) antes de liberar. Funciona no solo e também nas salas com amigos, na Copa do Brasil e no Brasileirão completo.',
  },
  {
    id: '2026-08-multiplayer-fases',
    date: 'Agosto de 2026',
    title: 'Multiplayer: sem cronômetro, agora em 2 fases',
    desc: 'A sala com amigos tirou o cronômetro do draft e passou a rodar em duas fases separadas: primeiro todo mundo escolhe sua formação (esquema pronto ou o editor livre), e só depois que todos estão prontos começa o sorteio dos elencos. Menos pressa, mais tempo pra pensar no esquema.',
  },
  {
    id: '2026-08-escudos-ranking',
    date: 'Agosto de 2026',
    title: 'Escudos dos clubes na tabela e no Ranking Global',
    desc: 'Os escudos dos times voltaram a aparecer certinho na tabela do Brasileirão e da Copa no multiplayer, e agora também aparecem do lado do nome de cada jogador no Ranking Global.',
  },
  {
    id: '2026-08-formacoes-revisao',
    date: 'Agosto de 2026',
    title: 'Revisão das formações táticas: nomes batendo com o esquema',
    desc: 'Conferimos todas as formações do jogo pra garantir que nenhuma tivesse o mesmo esquema com nome diferente e que o nome realmente correspondesse ao time em campo — por exemplo, o 4-3-1-2 agora tem uma versão equilibrada (3 meias + 1 armador) e uma defensiva (3 volantes + 1 armador), cada uma jogando de um jeito diferente de verdade.',
  },
  {
    id: '2026-08-mobile-botoes',
    date: 'Agosto de 2026',
    title: 'Botões e textos mais organizados no celular e tablet',
    desc: 'Revisão geral de toque no mobile/tablet: botões desproporcionais foram ajustados, textos de botão que quebravam feio agora se ajustam à tela, e o rodapé ficou menos poluído. Os campos táticos da escalação também ficaram menos exagerados de tamanho, inclusive no desktop.',
  },
  {
    id: '2026-08-meu-clube-melhorias',
    date: 'Agosto de 2026',
    title: '"Meu Clube" com Recordes, estádio e conquistas mais bonitas',
    desc: 'A tela "Meu Clube" ganhou uma seção de Recordes (melhor posição, melhor saldo de gols, maior overall de elenco e de jogador, sequências de invencibilidade, vitórias no multiplayer), um campo pra cadastrar o estádio do seu clube do lado do estado, e o mural de conquistas foi redesenhado — agora é uma grade de ícones em vez de uma parede de pílulas, com "+N" pra ver o resto. E o Galvão Bueno parou de gritar sozinho toda vez que a tela abre: o áudio ambiente agora só toca se você ligar.',
  },
  {
    id: '2026-08-supercopa',
    date: 'Agosto de 2026',
    title: 'Desafio do Dia virou Supercopa do Brasil',
    desc: 'O antigo "Desafio do Dia" foi redesenhado: agora você monta seu próprio time do zero, no draft, pra enfrentar um adversário lendário escolhido do dia, num confronto único estilo Supercopa. Continua valendo pontos de ranking e só dá pra jogar uma vez por dia.',
  },
  {
    id: '2026-08-fix-pontos-save',
    date: 'Agosto de 2026',
    title: 'Correção: pontos do multiplayer e saves cruzados',
    desc: 'Corrigimos um bug em que partidas do multiplayer às vezes não somavam pontos no ranking, e outro mais sério em que, em certos casos, sair de uma sala de multiplayer podia sobrescrever o save da sua campanha solo. Os dois já estão resolvidos.',
  },
  {
    id: '2026-08-seguranca-conta',
    date: 'Agosto de 2026',
    title: 'Mais segurança pra sua conta',
    desc: 'Agora é preciso confirmar sua senha atual pra trocar e-mail/senha ou excluir a conta, e adicionamos limites de requisição pra evitar abuso em alguns endpoints. Nada muda no seu dia a dia — é proteção nos bastidores.',
  },
  {
