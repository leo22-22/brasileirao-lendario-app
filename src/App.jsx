...
const TEAMS = [
  ...
  },
  {
    ...
    players: [
      { name: 'Alex Muralha', pos: ['GOL'], ovr: 76 },
      { name: 'Lucas Ramon', pos: ['LD', 'MD'], ovr: 75 },
      { name: 'Joao Victor', pos: ['ZAG'], ovr: 75 },
      { name: 'Luiz Otavio', pos: ['ZAG'], ovr: 75 },
      { name: 'Reinaldo', pos: ['LE', 'ME'], ovr: 77 },
      { name: 'Neto Moura', pos: ['VOL', 'MC'], ovr: 75 },
      { name: 'Jose Aldo', pos: ['MC', 'VOL'], ovr: 74 },
      { name: 'Danielzinho', pos: ['MEI', 'MC'], ovr: 78 },
      { name: 'Chico Kim', pos: ['MC', 'MEI'], ovr: 74 },
      { name: 'Edson Carioca', pos: ['PD', 'MD'], ovr: 75 },
      { name: 'Alesson', pos: ['ATA', 'PE'], ovr: 76 },
      { name: 'Negueba', pos: ['PE', 'PD'], ovr: 75 },
      { name: 'Igor Formiga', pos: ['ATA', 'PE'], ovr: 75 },
      { name: 'Nathan Fogaca', pos: ['ATA'], ovr: 74 },
      { name: 'Andre Luis', pos: ['MEI', 'PD'], ovr: 76 },
      { name: 'Denilson', pos: ['VOL'], ovr: 74 },
      { name: 'Lucas Oliveira', pos: ['ZAG'], ovr: 74 },
      { name: 'Guilherme Marques', pos: ['MC', 'VOL'], ovr: 73 },
      { name: 'Walter', pos: ['GOL'], ovr: 73 },
      { name: 'Cristian', pos: ['PE', 'PD'], ovr: 73 },
    ]
  },
  {
  ...
  {
    id: 'bragantino2026', club: 'Bragantino', year: 2026, label: 'Red Bull Bragantino 2026', coach: 'A confirmar',
    colors: { p: '#E30613', s: '#ffffff' },
    players: [
      { name: 'Cleiton', pos: ['GOL'], ovr: 81 },
      { name: 'Andres Hurtado', pos: ['LD', 'MD'], ovr: 76 },
      { name: 'Pedro Henrique', pos: ['ZAG'], ovr: 78 },
      { name: 'Eduardo Santos', pos: ['ZAG'], ovr: 77 },
      { name: 'Juninho Capixaba', pos: ['LE', 'ME'], ovr: 77 },
      { name: 'Jadsom', pos: ['VOL'], ovr: 76 },
      { name: 'Gabriel', pos: ['MC', 'VOL'], ovr: 76 },
      { name: 'Lucas Barbosa', pos: ['PD', 'PE'], ovr: 78 },
      { name: 'Vitinho', pos: ['PE', 'PD'], ovr: 78 },
      { name: 'Isidro Pitta', pos: ['ATA'], ovr: 78 },
      { name: 'Eduardo Sasha', pos: ['ATA', 'MEI'], ovr: 77 },
      { name: 'Thiago Borbas', pos: ['ATA'], ovr: 78 },
      { name: 'Nacho Laquintana', pos: ['MEI', 'PD'], ovr: 77 },
      { name: 'Praxedes', pos: ['MEI', 'MC'], ovr: 76 },
      { name: 'Matheus Fernandes', pos: ['VOL', 'MC'], ovr: 76 },
      { name: 'Lucas Cunha', pos: ['ZAG'], ovr: 76 },
      { name: 'Luan Candido', pos: ['LE', 'ZAG'], ovr: 76 },
      { name: 'Gustavinho', pos: ['PE', 'PD'], ovr: 74 },
      { name: 'Lucao', pos: ['GOL'], ovr: 74 },
      { name: 'Fabinho', pos: ['VOL', 'MC'], ovr: 75 },
    ]
  },
  {
