...
const TEAMS = [
  ...
  },
  {
    ...
    colors: { p: '#C8102E', s: '#000000' },
    players: [
      { name: 'Mycael', pos: ['GOL'], ovr: 78 },
      { name: 'Leo Godoy', pos: ['LD', 'MD'], ovr: 76 },
      { name: 'Thiago Heleno', pos: ['ZAG'], ovr: 78 },
      { name: 'Belezi', pos: ['ZAG'], ovr: 76 },
      { name: 'Esquivel', pos: ['LE', 'ME'], ovr: 76 },
      { name: 'Juan Portilla', pos: ['VOL'], ovr: 77 },
      { name: 'Luiz Gustavo', pos: ['VOL', 'MC'], ovr: 78 },
      { name: 'Zapelli', pos: ['MEI', 'MC'], ovr: 79 },
      { name: 'Julimar', pos: ['PE', 'PD'], ovr: 77 },
      { name: 'Mendoza', pos: ['PD', 'PE'], ovr: 77 },
      { name: 'Kevin Viveros', pos: ['ATA'], ovr: 83 },
      { name: 'Gilberto Junior', pos: ['LD', 'ZAG'], ovr: 76 },
      { name: 'Felipinho', pos: ['MC', 'VOL'], ovr: 75 },
      { name: 'Luiz Fernando', pos: ['PD', 'PE'], ovr: 76 },
      { name: 'Renan Peixoto', pos: ['ATA'], ovr: 75 },
      { name: 'Leo Derik', pos: ['ZAG'], ovr: 75 },
      { name: 'Kaua Moraes', pos: ['LD'], ovr: 74 },
      { name: 'Christian', pos: ['VOL', 'MC'], ovr: 75 },
      { name: 'Santos', pos: ['GOL'], ovr: 74 },
      { name: 'Benavidez', pos: ['VOL', 'MC'], ovr: 75 },
    ]
  },
  {
