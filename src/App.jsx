...
const TEAMS = [
  ...
  },
  {
    ...
    colors: { p: '#000000', s: '#ffffff' },
    players: [
      { name: 'Leo Linck', pos: ['GOL'], ovr: 78 },
      { name: 'Vitinho', pos: ['LD', 'MD'], ovr: 79 },
      { name: 'Alexander Barboza', pos: ['ZAG'], ovr: 82 },
      { name: 'Kaio Pantaleao', pos: ['ZAG'], ovr: 77 },
      { name: 'Alex Telles', pos: ['LE', 'ME'], ovr: 80 },
      { name: 'Gregore', pos: ['VOL'], ovr: 80 },
      { name: 'Marlon Freitas', pos: ['VOL', 'MC'], ovr: 79 },
      { name: 'Savarino', pos: ['MEI', 'PD'], ovr: 82 },
      { name: 'Artur', pos: ['PD', 'PE'], ovr: 82 },
      { name: 'Arthur Cabral', pos: ['ATA'], ovr: 80 },
      { name: 'Jeffinho', pos: ['PE', 'ATA'], ovr: 78 },
      { name: 'Danilo Barbosa', pos: ['VOL', 'ZAG'], ovr: 78 },
      { name: 'Newton', pos: ['MC', 'VOL'], ovr: 76 },
      { name: 'Cuiabano', pos: ['LE', 'PE'], ovr: 78 },
      { name: 'Bastos', pos: ['ZAG'], ovr: 79 },
      { name: 'Matheus Martins', pos: ['PE', 'ATA'], ovr: 77 },
      { name: 'Montoro', pos: ['MEI', 'MC'], ovr: 76 },
      { name: 'Chris Ramos', pos: ['ATA'], ovr: 77 },
      { name: 'Mateo Ponte', pos: ['LD'], ovr: 77 },
      { name: 'Raul', pos: ['GOL'], ovr: 74 },
    ]
  },
  {
