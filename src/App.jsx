...
const TEAMS = [
  ...
  },
  {
    ...
    colors: { p: '#006437', s: '#ffffff' },
    players: [
      { name: 'Gabriel Leite', pos: ['GOL'], ovr: 77 },
      { name: 'Tinga', pos: ['LD', 'MD'], ovr: 76 },
      { name: 'Rodrigo Moledo', pos: ['ZAG'], ovr: 77 },
      { name: 'William Machado', pos: ['ZAG'], ovr: 76 },
      { name: 'Bruno Melo', pos: ['LE', 'ME'], ovr: 76 },
      { name: 'Wallisson', pos: ['VOL'], ovr: 76 },
      { name: 'Willian Oliveira', pos: ['VOL', 'MC'], ovr: 76 },
      { name: 'Josue', pos: ['MC', 'MEI'], ovr: 78 },
      { name: 'Sebastian Gomez', pos: ['MEI', 'MC'], ovr: 78 },
      { name: 'Clayson', pos: ['PD', 'PE'], ovr: 76 },
      { name: 'Pedro Rocha', pos: ['ATA'], ovr: 79 },
      { name: 'Iury Castilho', pos: ['PE', 'ATA'], ovr: 76 },
      { name: 'Gustavo', pos: ['MEI', 'MC'], ovr: 76 },
      { name: 'Tiago Coser', pos: ['ATA', 'PE'], ovr: 75 },
      { name: 'Lucca Prior', pos: ['MEI', 'PD'], ovr: 74 },
      { name: 'Chico da Costa', pos: ['ATA'], ovr: 75 },
      { name: 'Mauricio Antonio', pos: ['ZAG'], ovr: 74 },
      { name: 'Pedro Rangel', pos: ['GOL'], ovr: 75 },
      { name: 'Pedro Morisco', pos: ['GOL'], ovr: 74 },
      { name: 'Wallace Pernambucano', pos: ['PE', 'ATA'], ovr: 74 },
    ]
  },
  {
