...
const TEAMS = [
  ...
  },
  {
    ...
    colors: { p: '#000000', s: '#ffffff' },
    players: [
      { name: 'Gabriel Brazao', pos: ['GOL'], ovr: 84 },
      { name: 'Igor Vinicius', pos: ['LD', 'MD'], ovr: 77 },
      { name: 'Lucas Verissimo', pos: ['ZAG'], ovr: 83 },
      { name: 'Luan Peres', pos: ['ZAG', 'LE'], ovr: 77 },
      { name: 'Escobar', pos: ['LE', 'ME'], ovr: 76 },
      { name: 'Gustavinho', pos: ['VOL', 'MC'], ovr: 79 },
      { name: 'Oliva', pos: ['VOL', 'MC'], ovr: 78 },
      { name: 'Gabriel Bontempo', pos: ['MD', 'MC', 'VOL', 'MEI'], ovr: 82 },
      { name: 'Barreal', pos: ['ME', 'PE', 'LE', 'MC'], ovr: 83 },
      { name: 'Neymar', pos: ['MEI', 'PE', 'ATA'], ovr: 89 },
      { name: 'Gabigol', pos: ['ATA'], ovr: 85 },
      { name: 'Diogenes', pos: ['GOL'], ovr: 76 },
      { name: 'Gabriel Menino', pos: ['LD', 'MD', 'MC'], ovr: 77 },
      { name: 'Joao Ananias', pos: ['ZAG'], ovr: 76 },
      { name: 'Vinicius Lira', pos: ['LE'], ovr: 75 },
      { name: 'Joao Schmidt', pos: ['VOL', 'MC'], ovr: 78 },
      { name: 'William Arao', pos: ['VOL', 'ZAG', 'MC'], ovr: 78 },
      { name: 'Rollheiser', pos: ['MEI', 'PD', 'MD', 'MC'], ovr: 82 },
      { name: 'Robinho Jr', pos: ['PD', 'MD', 'PE'], ovr: 75 },
      { name: 'Rony Rustico', pos: ['ATA', 'PD', 'PE', 'MD', 'ME'], ovr: 77 },
    ]
  },
  {
