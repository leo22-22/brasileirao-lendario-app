...
const TEAMS = [
  ...
  },
  {
    ...
    players: [
      ...
      { name: 'Santiago Arias', pos: ['LD', 'MD'], ovr: 78 },
      { name: 'Kanu', pos: ['ZAG'], ovr: 78 },
      { name: 'Ramos Mingo', pos: ['ZAG'], ovr: 78 },
      { name: 'Luciano Juba', pos: ['LE', 'PE'], ovr: 79 },
      { name: 'Rezende', pos: ['VOL'], ovr: 77 },
      { name: 'Caio Alexandre', pos: ['MC', 'VOL'], ovr: 80 },
      { name: 'Everton Ribeiro', pos: ['MEI', 'PD'], ovr: 80 },
      { name: 'Cauly', pos: ['MEI', 'MC'], ovr: 80 },
      { name: 'Ademir', pos: ['PD', 'PE'], ovr: 78 },
      { name: 'Willian Jose', pos: ['ATA'], ovr: 80 },
      { name: 'Jean Lucas', pos: ['MC', 'VOL'], ovr: 79 },
      { name: 'Biel', pos: ['PE', 'PD'], ovr: 78 },
      { name: 'Michel Araujo', pos: ['MEI', 'MC'], ovr: 78 },
      { name: 'Tiago', pos: ['ZAG'], ovr: 77 },
      { name: 'Iago Borduchi', pos: ['LE'], ovr: 76 },
      { name: 'David Duarte', pos: ['ZAG'], ovr: 76 },
      { name: 'Erick', pos: ['ATA', 'PE'], ovr: 76 },
      { name: 'Marcos Felipe', pos: ['GOL'], ovr: 77 },
      { name: 'Acevedo', pos: ['VOL', 'MC'], ovr: 77 },
    ]
  },
  {
  ...
  {
    id: 'internacional2026', club: 'Internacional', year: 2026, label: 'Internacional 2026', coach: 'Ramon Diaz',
    colors: { p: '#D2122E', s: '#ffffff' },
    players: [
      { name: 'Rochet', pos: ['GOL'], ovr: 83 },
      { name: 'Braian Aguirre', pos: ['LD', 'MD'], ovr: 77 },
      { name: 'Vitao', pos: ['ZAG'], ovr: 82 },
      { name: 'Victor Gabriel', pos: ['ZAG'], ovr: 76 },
      { name: 'Bernabei', pos: ['LE', 'ME'], ovr: 79 },
      { name: 'Thiago Maia', pos: ['VOL', 'MC'], ovr: 79 },
      { name: 'Bruno Henrique', pos: ['MC', 'VOL'], ovr: 79 },
      { name: 'Alan Patrick', pos: ['MEI', 'MC'], ovr: 84 },
      { name: 'Carbonero', pos: ['PD', 'PE'], ovr: 79 },
      { name: 'Vitinho', pos: ['PE', 'PD'], ovr: 77 },
      { name: 'Borre', pos: ['ATA'], ovr: 81 },
      { name: 'Alan Rodriguez', pos: ['MC', 'VOL'], ovr: 77 },
      { name: 'Oscar Romero', pos: ['MEI', 'MC'], ovr: 77 },
      { name: 'Bruno Gomes', pos: ['VOL', 'MC'], ovr: 77 },
      { name: 'Mercado', pos: ['ZAG'], ovr: 77 },
      { name: 'Ricardo Mathias', pos: ['ATA'], ovr: 76 },
      { name: 'Wesley', pos: ['PE', 'PD'], ovr: 76 },
      { name: 'Ronaldo', pos: ['MEI', 'MC'], ovr: 76 },
      { name: 'Anthoni', pos: ['GOL'], ovr: 77 },
      { name: 'Gabriel Carvalho', pos: ['MEI', 'ME'], ovr: 77 },
    ]
  },
  {
  ...
  {
    id: 'vitoria2026', club: 'Vitoria', year: 2026, label: 'Vitoria 2026', coach: 'A confirmar',
    colors: { p: '#C8102E', s: '#000000' },
    players: [
      { name: 'Lucas Arcanjo', pos: ['GOL'], ovr: 77 },
      { name: 'Raul Caceres', pos: ['LD', 'MD'], ovr: 75 },
      { name: 'Ze Marcos', pos: ['ZAG'], ovr: 75 },
      { name: 'Camutanga', pos: ['ZAG'], ovr: 75 },
      { name: 'Jamerson', pos: ['LE', 'ME'], ovr: 74 },
      { name: 'Ricardo Ryller', pos: ['VOL'], ovr: 75 },
      { name: 'Pepe', pos: ['VOL', 'MC'], ovr: 75 },
      { name: 'Matheusinho', pos: ['MEI', 'PD'], ovr: 76 },
      { name: 'Erick', pos: ['MEI', 'MC'], ovr: 76 },
      { name: 'Osvaldo', pos: ['PD', 'PE'], ovr: 75 },
      { name: 'Renato Kayzer', pos: ['ATA'], ovr: 77 },
      { name: 'Romarinho', pos: ['ATA', 'MEI'], ovr: 76 },
      { name: 'Erick Marcus', pos: ['MEI', 'PE'], ovr: 75 },
      { name: 'Lucas Braga', pos: ['PE', 'PD'], ovr: 75 },
      { name: 'Cantalapiedra', pos: ['MEI', 'PD'], ovr: 76 },
      { name: 'Neris', pos: ['ZAG'], ovr: 74 },
      { name: 'Maykon Jesus', pos: ['LE'], ovr: 73 },
      { name: 'Edu', pos: ['ATA'], ovr: 74 },
      { name: 'Fabri', pos: ['GOL'], ovr: 74 },
      { name: 'Gustavo Mosquito', pos: ['PD', 'PE'], ovr: 75 },
    ]
  },
  {
