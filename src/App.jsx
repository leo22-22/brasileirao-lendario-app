...
const TEAMS = [
  ...
  },
  {
    ...
    colors: { p: '#000000', s: '#ffffff' },
    players: [
      { name: 'Leo Jardim', pos: ['GOL'], ovr: 84 },
      { name: 'Paulo Henrique', pos: ['LD', 'MD'], ovr: 77 },
      { name: 'Cuesta', pos: ['ZAG'], ovr: 78 },
      { name: 'Robert Renan', pos: ['ZAG'], ovr: 78 },
      { name: 'Lucas Piton', pos: ['LE', 'ME'], ovr: 80 },
      { name: 'Hugo Moura', pos: ['VOL'], ovr: 77 },
      { name: 'Tche Tche', pos: ['VOL', 'MC'], ovr: 76 },
      { name: 'Coutinho', pos: ['MEI', 'ME'], ovr: 82 },
      { name: 'Nuno Moreira', pos: ['PE', 'PD'], ovr: 80 },
      { name: 'Rayan', pos: ['ATA', 'PE'], ovr: 81 },
      { name: 'Vegetti', pos: ['ATA'], ovr: 82 },
      { name: 'David', pos: ['PD', 'ATA'], ovr: 78 },
      { name: 'Andres Gomez', pos: ['PD', 'PE'], ovr: 78 },
      { name: 'Mateus Carvalho', pos: ['VOL', 'MC'], ovr: 76 },
      { name: 'Barros', pos: ['MC', 'MEI'], ovr: 76 },
      { name: 'Lucas Freitas', pos: ['ZAG'], ovr: 76 },
      { name: 'Puma Rodriguez', pos: ['LD'], ovr: 76 },
      { name: 'Loide Augusto', pos: ['PE', 'ATA'], ovr: 75 },
      { name: 'Daniel Fuzato', pos: ['GOL'], ovr: 76 },
      { name: 'Jean David', pos: ['PE', 'ATA'], ovr: 76 },
    ]
  },
  {
  ...
  {
    id: 'santos2026', club: 'Santos', year: 2026, label: 'Santos 2026 (Neymar na Vila)', coach: 'Juan Pablo Vojvoda',
    colors: { p: '#000000', s: '#ffffff' },
    players: [
      { name: 'Gabriel Brazao', pos: ['GOL'], ovr: 80 },
      { name: 'Igor Vinicius', pos: ['LD', 'MD'], ovr: 77 },
      { name: 'Adonis Frias', pos: ['ZAG'], ovr: 78 },
      { name: 'Zaid', pos: ['ZAG'], ovr: 76 },
      { name: 'Escobar', pos: ['LE', 'ME'], ovr: 76 },
      { name: 'Ze Rafael', pos: ['VOL', 'MC'], ovr: 79 },
      { name: 'Joao Schmidt', pos: ['VOL', 'MC'], ovr: 77 },
      { name: 'Rollheiser', pos: ['MEI', 'MC'], ovr: 80 },
      { name: 'Neymar', pos: ['MEI', 'ATA'], ovr: 88 },
      { name: 'Guilherme', pos: ['PD', 'ATA'], ovr: 80 },
      { name: 'Lautaro Diaz', pos: ['ATA'], ovr: 77 },
      { name: 'Barreal', pos: ['PE', 'MEI'], ovr: 78 },
      { name: 'Victor Hugo', pos: ['MEI', 'MC'], ovr: 78 },
      { name: 'Willian Arao', pos: ['VOL', 'ZAG'], ovr: 78 },
      { name: 'Thaciano', pos: ['MEI', 'MC'], ovr: 78 },
      { name: 'Luan Peres', pos: ['ZAG'], ovr: 77 },
      { name: 'Souza', pos: ['LE'], ovr: 76 },
      { name: 'Robinho Jr', pos: ['ATA', 'PE'], ovr: 74 },
      { name: 'Diogenes', pos: ['GOL'], ovr: 74 },
      { name: 'Tiquinho Soares', pos: ['ATA'], ovr: 76 },
    ]
  },
  {
