...
const TEAMS = [
  ...
  {
    id: 'atleticomg2026', club: 'Atletico-MG', year: 2026, label: 'Atletico-MG 2026', coach: 'Cuca',
    colors: { p: '#000000', s: '#ffffff' },
    players: [
      { name: 'Everson', pos: ['GOL'], ovr: 82 },
      { name: 'Saravia', pos: ['LD', 'MD'], ovr: 77 },
      { name: 'Junior Alonso', pos: ['ZAG'], ovr: 80 },
      { name: 'Lyanco', pos: ['ZAG'], ovr: 79 },
      { name: 'Guilherme Arana', pos: ['LE', 'ME'], ovr: 82 },
      { name: 'Alan Franco', pos: ['VOL'], ovr: 79 },
      { name: 'Fausto Vera', pos: ['VOL', 'MC'], ovr: 78 },
      { name: 'Gustavo Scarpa', pos: ['MEI', 'ME'], ovr: 83 },
      { name: 'Bernard', pos: ['MEI', 'PE'], ovr: 80 },
      { name: 'Hulk', pos: ['ATA', 'PE'], ovr: 84 },
      { name: 'Rony', pos: ['ATA', 'PD'], ovr: 79 },
      { name: 'Cuello', pos: ['PD', 'PE'], ovr: 79 },
      { name: 'Dudu', pos: ['PD', 'MEI'], ovr: 77 },
      { name: 'Igor Gomes', pos: ['MC', 'MEI'], ovr: 77 },
      { name: 'Vitor Hugo', pos: ['ZAG'], ovr: 77 },
      { name: 'Caio Paulista', pos: ['LE', 'PE'], ovr: 76 },
      { name: 'Ruan', pos: ['ZAG'], ovr: 76 },
      { name: 'Alisson', pos: ['MC', 'VOL'], ovr: 76 },
      { name: 'Gabriel Delfim', pos: ['GOL'], ovr: 74 },
      { name: 'Natanael', pos: ['LE', 'ME'], ovr: 78 },
    ]
  },
  {
