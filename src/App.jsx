...
const TEAMS = [
  ...
  // ── CAMPEÕES BRASILEIROS FALTANTES ──────────────────────────────────────

  { id: 'flamengo1992', club: 'Flamengo', year: 1992, label: 'Flamengo 1992', coach: 'Nelsinho Baptista',
    colors: { p: '#cc0000', s: '#0a0a0a' },
    players: [
      { name: 'Zé Carlos', pos: ['GOL'], ovr: 80 },
      { name: 'Leandro', pos: ['LD', 'PD'], ovr: 82 },
      { name: 'Carlos', pos: ['ZAG'], ovr: 76 },
      { name: 'Chico Anysio', pos: ['ZAG'], ovr: 75 },
      { name: 'Júnior', pos: ['LE', 'PE'], ovr: 80 },
      { name: 'Marquinhos', pos: ['VOL'], ovr: 78 },
      { name: 'Djalminha', pos: ['MEI'], ovr: 85 },
      { name: 'Fabio Baiano', pos: ['MEI'], ovr: 80 },
      { name: 'Marcelinho Carioca', pos: ['MEI'], ovr: 83 },
      { name: 'Sávio', pos: ['PD', 'ATA'], ovr: 88 },
      { name: 'Paulo Nunes', pos: ['ATA'], ovr: 80 },
      { name: 'Nélio', pos: ['MEI'], ovr: 77 },
      { name: 'Luís Antônio', pos: ['MEI'], ovr: 76 },
      { name: 'Tita', pos: ['ATA', 'MEI'], ovr: 75 },
      { name: 'William', pos: ['ATA'], ovr: 73 },
      { name: 'Piá', pos: ['LE'], ovr: 73 },
      { name: 'Selé', pos: ['LE'], ovr: 71 },
      { name: 'Edinho', pos: ['PE'], ovr: 72 },
      { name: 'Celso', pos: ['VOL'], ovr: 70 },
      { name: 'Reginaldo Araújo', pos: ['ATA'], ovr: 72 },
    ]},

  { id: 'corinthians1998', club: 'Corinthians', year: 1998, label: 'Corinthians 1998', coach: 'Vanderlei Luxemburgo',
    colors: { p: '#0a0a0a', s: '#f5f5f5' },
    players: [
  ...
  { id: 'saopaulo2008', club: 'São Paulo', year: 2008, label: 'São Paulo 2008', coach: 'Muricy Ramalho',
    colors: { p: '#c8102e', s: '#0a0a0a' },
    players: [
      { name: 'Rogério Ceni', pos: ['GOL'], ovr: 88 },
      { name: 'Cicinho', pos: ['LD', 'PD'], ovr: 78 },
      { name: 'Fabão', pos: ['ZAG'], ovr: 80 },
      { name: 'Miranda', pos: ['ZAG'], ovr: 85 },
      { name: 'Lugano', pos: ['ZAG'], ovr: 84 },
      { name: 'Júnior', pos: ['LE'], ovr: 76 },
      { name: 'Mineiro', pos: ['VOL'], ovr: 82 },
      { name: 'Josué', pos: ['VOL', 'MEI'], ovr: 80 },
      { name: 'Souza', pos: ['MEI'], ovr: 79 },
      { name: 'Danilo', pos: ['MEI'], ovr: 80 },
      ...
      { name: 'Aloísio', pos: ['ATA'], ovr: 79 },
      { name: 'Jadson', pos: ['MEI'], ovr: 77 },
      { name: 'Ilsinho', pos: ['LD', 'PD'], ovr: 77 },
      { name: 'Éder Luís', pos: ['ATA'], ovr: 74 },
      { name: 'Alex Silva', pos: ['ZAG'], ovr: 74 },
      { name: 'Junior Cesar', pos: ['LE'], ovr: 72 },
    ]},

  { id: 'flamengo2009', club: 'Flamengo', year: 2009, label: 'Flamengo 2009', coach: 'Andrade',
    colors: { p: '#cc0000', s: '#0a0a0a' },
    players: [
      { name: 'Bruno', pos: ['GOL'], ovr: 87 },
      { name: 'Léo Moura', pos: ['LD', 'PD'], ovr: 86 },
      { name: 'Ronaldo Angelim', pos: ['ZAG'], ovr: 82 },
      { name: 'Juan', pos: ['ZAG'], ovr: 84 },
      { name: 'Álvaro', pos: ['ZAG'], ovr: 78 },
      ...
      { name: 'Zé Roberto', pos: ['MEI', 'ATA'], ovr: 80 },
  ...
  { id: 'corinthians2011', club: 'Corinthians', year: 2011, label: 'Corinthians 2011', coach: 'Tite',
    colors: { p: '#0a0a0a', s: '#f5f5f5' },
    players: [
      { name: 'Cássio', pos: ['GOL'], ovr: 87 },
      { name: 'Alessandro', pos: ['LD'], ovr: 80 },
      { name: 'Chicão', pos: ['ZAG'], ovr: 84 },
      { name: 'Leandro Castán', pos: ['ZAG'], ovr: 84 },
      { name: 'Paulo André', pos: ['ZAG'], ovr: 80 },
      { name: 'Fábio Santos', pos: ['LE'], ovr: 82 },
  ...
  { id: 'fluminense2012', club: 'Fluminense', year: 2012, label: 'Fluminense 2012', coach: 'Abel Braga',
    colors: { p: '#6b0c1a', s: '#5cae44' },
    players: [
      { name: 'Diego Cavalieri', pos: ['GOL'], ovr: 84 },
      { name: 'Bruno', pos: ['LD'], ovr: 81 },
      { name: 'Gum', pos: ['ZAG'], ovr: 85 },
      { name: 'Leandro Euzébio', pos: ['ZAG'], ovr: 82 },
      { name: 'Carlinhos', pos: ['LE'], ovr: 82 },
      ...
      { name: 'Rafael Sóbis', pos: ['ATA'], ovr: 82 },
  ...
  { id: 'cruzeiro2013', club: 'Cruzeiro', year: 2013, label: 'Cruzeiro 2013', coach: 'Marcelo Oliveira',
    colors: { p: '#0040a0', s: '#f5f5f5' },
    players: [
      { name: 'Fábio', pos: ['GOL'], ovr: 87 },
      { name: 'Ceará', pos: ['LD'], ovr: 82 },
      { name: 'Dedé', pos: ['ZAG'], ovr: 88 },
      { name: 'Bruno Rodrigo', pos: ['ZAG'], ovr: 81 },
      { name: 'Léo', pos: ['ZAG'], ovr: 79 },
      { name: 'Egídio', pos: ['LE'], ovr: 80 },
      { name: 'Lucas Silva', pos: ['VOL'], ovr: 83 },
      { name: 'Nilton', pos: ['VOL'], ovr: 84 },
      { name: 'Éverton Ribeiro', pos: ['MEI', 'PD'], ovr: 91 },
      { name: 'Ricardo Goulart', pos: ['MEI', 'ATA'], ovr: 88 },
      { name: 'Júlio Baptista', pos: ['MEI'], ovr: 79 },
      ...
      { name: 'Samúdio', pos: ['LE'], ovr: 73 },
      { name: 'Cris', pos: ['ZAG'], ovr: 78 },
      { name: 'Rafael', pos: ['GOL'], ovr: 75 },
    ]},

  { id: 'cruzeiro2014', club: 'Cruzeiro', year: 2014, label: 'Cruzeiro 2014', coach: 'Marcelo Oliveira',
    colors: { p: '#0040a0', s: '#f5f5f5' },
    players: [
      { name: 'Fábio', pos: ['GOL'], ovr: 87 },
      { name: 'Ceará', pos: ['LD'], ovr: 82 },
  ...
  { id: 'corinthians2015', club: 'Corinthians', year: 2015, label: 'Corinthians 2015', coach: 'Tite',
    colors: { p: '#0a0a0a', s: '#f5f5f5' },
    players: [
      { name: 'Cássio', pos: ['GOL'], ovr: 89 },
      { name: 'Fagner', pos: ['LD'], ovr: 82 },
      { name: 'Alessandro', pos: ['LD'], ovr: 78 },
      { name: 'Gil Baiano', pos: ['ZAG'], ovr: 87 },
      { name: 'Edu Dracena', pos: ['ZAG'], ovr: 84 },
      { name: 'Chicão', pos: ['ZAG'], ovr: 82 },
      { name: 'Uendel', pos: ['LE'], ovr: 78 },
      { name: 'Guilherme Arana', pos: ['LE'], ovr: 78 },
      { name: 'Ralf', pos: ['VOL'], ovr: 85 },
      { name: 'Elias', pos: ['VOL', 'MEI'], ovr: 84 },
      { name: 'Willian Arão', pos: ['VOL'], ovr: 80 },
  ...
  { id: 'corinthians2017', club: 'Corinthians', year: 2017, label: 'Corinthians 2017', coach: 'Fábio Carille',
    colors: { p: '#0a0a0a', s: '#f5f5f5' },
    players: [
      ...
      { name: 'Léo Santos', pos: ['ZAG'], ovr: 78 },
      ...
      { name: 'Jo', pos: ['ATA'], ovr: 75 },
      { name: 'Kazim', pos: ['ATA'], ovr: 73 },
      { name: 'Carlos', pos: ['LD'], ovr: 71 },
    ]},

  { id: 'palmeiras2018', club: 'Palmeiras', year: 2018, label: 'Palmeiras 2018', coach: 'Luiz Felipe Scolari',
    colors: { p: '#006437', s: '#f5f5f5' },
    players: [
      { name: 'Weverton', pos: ['GOL'], ovr: 89 },
      { name: 'Marcos Rocha', pos: ['LD'], ovr: 84 },
      { name: 'Mayke', pos: ['LD'], ovr: 80 },
      { name: 'Gustavo Gómez', pos: ['ZAG'], ovr: 88 },
      { name: 'Luan', pos: ['ZAG'], ovr: 83 },
      { name: 'Edu Dracena', pos: ['ZAG'], ovr: 82 },
      { name: 'Diogo Barbosa', pos: ['LE'], ovr: 82 },
      { name: 'Moisés', pos: ['VOL', 'LE'], ovr: 79 },
      ...
      { name: 'Mário Sérgio', pos: ['LE'], ovr: 78 },
      { name: 'Rafael Marques', pos: ['ATA'], ovr: 76 },
    ]},

  { id: 'flamengo2019', club: 'Flamengo', year: 2019, label: 'Flamengo 2019', coach: 'Jorge Jesus',
    colors: { p: '#cc0000', s: '#0a0a0a' },
    players: [
      { name: 'Diego Alves', pos: ['GOL'], ovr: 87 },
      { name: 'Rafinha', pos: ['LD'], ovr: 86 },
      { name: 'Rodrigo Caio', pos: ['ZAG'], ovr: 86 },
      { name: 'Pablo Marí', pos: ['ZAG'], ovr: 85 },
      { name: 'Filipe Luís', pos: ['LE'], ovr: 91 },
      { name: 'Willian Arão', pos: ['VOL'], ovr: 88 },
      { name: 'Cuéllar', pos: ['VOL'], ovr: 85 },
      ...
      { name: 'Rafinha M.', pos: ['ZAG'], ovr: 78 },
    ]},

  { id: 'flamengo2020', club: 'Flamengo', year: 2020, label: 'Flamengo 2020', coach: 'Rogério Ceni',
    colors: { p: '#cc0000', s: '#0a0a0a' },
    players: [
      ...
      { name: 'Léo Pereira', pos: ['ZAG'], ovr: 84 },
      { name: 'Léo Ortiz', pos: ['ZAG'], ovr: 80 },
      { name: 'Filipe Luís', pos: ['LE'], ovr: 89 },
      { name: 'Renê', pos: ['LE'], ovr: 82 },
      { name: 'Willian Arão', pos: ['VOL'], ovr: 88 },
  ...
  { id: 'atleticobh2021', club: 'Atlético-MG', year: 2021, label: 'Atlético-MG 2021', coach: 'Cuca',
    colors: { p: '#0a0a0a', s: '#f5f5f5' },
    players: [
      { name: 'Éverson', pos: ['GOL'], ovr: 88 },
      { name: 'Marcelinho Moreno', pos: ['ATA'], ovr: 77 },
      { name: 'Guilherme Arana', pos: ['LE'], ovr: 88 },
      { name: 'Réver', pos: ['ZAG'], ovr: 82 },
      ...
      { name: 'Nacho Fernández', pos: ['MEI'], ovr: 90 },
  ...
  { id: 'palmeiras2022', club: 'Palmeiras', year: 2022, label: 'Palmeiras 2022', coach: 'Abel Ferreira',
    colors: { p: '#006437', s: '#f5f5f5' },
    players: [
      { name: 'Weverton', pos: ['GOL'], ovr: 92 },
      { name: 'Marcos Rocha', pos: ['LD'], ovr: 84 },
      { name: 'Mayke', pos: ['LD'], ovr: 81 },
      { name: 'Gustavo Gómez', pos: ['ZAG'], ovr: 90 },
      ...
      { name: 'Flaco López', pos: ['ATA'], ovr: 86 },
      { name: 'Pedro Geromel', pos: ['ZAG'], ovr: 79 },
      { name: 'Jhon Jhon', pos: ['MEI'], ovr: 79 },
      { name: 'José Manuel López', pos: ['ATA'], ovr: 75 },
    ]},

  { id: 'palmeiras2023', club: 'Palmeiras', year: 2023, label: 'Palmeiras 2023', coach: 'Abel Ferreira',
    colors: { p: '#006437', s: '#f5f5f5' },
    players: [
  ...
  { id: 'botafogo2023', club: 'Botafogo', year: 2023, label: 'Botafogo 2023', coach: 'Luis Castro',
    ...
    players: [
      ...
      { name: 'Niko Kühnel', pos: ['MEI'], ovr: 76 },
    ]},

  { id: 'botafogo2024', club: 'Botafogo', year: 2024, label: 'Botafogo 2024', coach: 'Artur Jorge',
    colors: { p: '#0a0a0a', s: '#f5f5f5' },
    players: [
  ...
  { id: 'santos1962', club: 'Santos', year: 1962, label: 'Santos 1962 · Lendário', coach: 'Lula',
    colors: { p: '#0a0a0a', s: '#f5f5f5' },
    players: [
      ...
      { name: 'Mengálvio', pos: ['VOL', 'MEI'], ovr: 86 },
      ...
      { name: 'Pagão', pos: ['LD'], ovr: 70 },
      { name: 'Orlando', pos: ['ATA'], ovr: 70 },
    ]},

  { id: 'vasco1974', club: 'Vasco', year: 1974, label: 'Vasco 1974 · Lendário', coach: 'Mario Travaglini',
    colors: { p: '#0a0a0a', s: '#f5f5f5' },
    players: [
      { name: 'Andrada', pos: ['GOL'], ovr: 80 },
      { name: 'Fidélis', pos: ['LD'], ovr: 76 },
      { name: 'Paulo César', pos: ['LD'], ovr: 74 },
      { name: 'Miguel', pos: ['ZAG'], ovr: 78 },
      { name: 'Moisés', pos: ['ZAG'], ovr: 79 },
  ...
  { id: 'vasco1998', club: 'Vasco', year: 1998, label: 'Vasco 1998 · Lendário', coach: 'Antônio Lopes',
    colors: { p: '#0a0a0a', s: '#f5f5f5' },
    players: [
      { name: 'Carlos Germano', pos: ['GOL'], ovr: 83 },
      { name: 'Vágner', pos: ['LD'], ovr: 79 },
      { name: 'César Prates', pos: ['LD'], ovr: 77 },
      { name: 'Mauro Galvão', pos: ['ZAG'], ovr: 82 },
  ...
  { id: 'atleticobh2013', club: 'Atlético-MG', year: 2013, label: 'Atlético-MG 2013 · Libertadores', coach: 'Cuca',
    colors: { p: '#0a0a0a', s: '#f5f5f5' },
    players: [
      { name: 'Victor', pos: ['GOL'], ovr: 93 },
      { name: 'Marcos Rocha', pos: ['LD'], ovr: 83 },
      { name: 'Michel', pos: ['LD'], ovr: 80 },
      { name: 'Réver', pos: ['ZAG'], ovr: 84 },
  ...
  { id: 'santos2010', club: 'Santos', year: 2010, label: 'Santos 2010 · Lendário', coach: 'Dorival Júnior',
    ...
    players: [
      ...
      { name: 'André', pos: ['ATA'], ovr: 82 },
      { name: 'Zé Eduardo', pos: ['ATA'], ovr: 79 },
      { name: 'Alan Kardec', pos: ['ATA'], ovr: 78 },
      { name: 'Felipe', pos: ['GOL'], ovr: 75 },
    ]},

  { id: 'santos2011', club: 'Santos', year: 2011, label: 'Santos 2011 · Lendário', coach: 'Muricy Ramalho',
    colors: { p: '#0a0a0a', s: '#f5f5f5' },
    players: [
      ...
      { name: 'Zé Eduardo', pos: ['ATA'], ovr: 80 },
      { name: 'Alan Kardec', pos: ['ATA'], ovr: 78 },
      { name: 'Maikon Leite', pos: ['ATA', 'PD'], ovr: 78 },
      { name: 'Felipe', pos: ['GOL'], ovr: 77 },
    ]},

  { id: 'santos2015', club: 'Santos', year: 2015, label: 'Santos 2015 · Lendário', coach: 'Dorival Júnior',
    colors: { p: '#0a0a0a', s: '#f5f5f5' },
    players: [
      ...
      { name: 'Léo Cittadini', pos: ['MEI'], ovr: 77 },
      ...
      { name: 'Pablo Rodrigues', pos: ['ATA'], ovr: 72 },
    ]},

  { id: 'athleticopr2019', club: 'Athletico-PR', year: 2019, label: 'Athletico-PR 2019 · Lendário', coach: 'Tiago Nunes',
    colors: { p: '#c8102e', s: '#0a0a0a' },
    players: [
      { name: 'Santos', pos: ['GOL'], ovr: 82 },
      { name: 'Jonathan Rios', pos: ['LD'], ovr: 78 },
      { name: 'Márcio Azevedo', pos: ['LD'], ovr: 79 },
      { name: 'Robson Bambu', pos: ['ZAG'], ovr: 79 },
      { name: 'Pedro Henrique', pos: ['ZAG'], ovr: 80 },
      { name: 'Thiago Heleno', pos: ['ZAG'], ovr: 82 },
      { name: 'Léo Pereira', pos: ['LE'], ovr: 80 },
      { name: 'Abner', pos: ['LE'], ovr: 77 },
      { name: 'Christian', pos: ['VOL'], ovr: 83 },
      { name: 'Matheus Fernandes', pos: ['VOL'], ovr: 82 },
      { name: 'Wellington', pos: ['VOL'], ovr: 79 },
      { name: 'Bruno Guimarães', pos: ['VOL', 'MEI'], ovr: 86 },
      { name: 'Lucho González', pos: ['MEI'], ovr: 83 },
      { name: 'Nikão', pos: ['MEI', 'PD'], ovr: 88 },
  ...
  { id: 'athleticopr2022', club: 'Athletico-PR', year: 2022, label: 'Athletico-PR 2022 · Lendário', coach: 'Luiz Felipe Scolari',
    colors: { p: '#c8102e', s: '#0a0a0a' },
    players: [
      ...
      { name: 'Rômulo', pos: ['ATA'], ovr: 83 },
      { name: 'Vitor Roque', pos: ['ATA'], ovr: 87 },
      { name: 'Pablo', pos: ['ATA'], ovr: 82 },
    ]},

  { id: 'santos2021', club: 'Santos', year: 2021, label: 'Santos 2021 · Lendário', coach: 'Fábio Carille',
    colors: { p: '#0a0a0a', s: '#f5f5f5' },
    players: [
      { name: 'João Paulo', pos: ['GOL'], ovr: 85 },
      { name: 'John', pos: ['GOL'], ovr: 79 },
      { name: 'Pará', pos: ['LD'], ovr: 79 },
      { name: 'Madson', pos: ['LD'], ovr: 78 },
      { name: 'Kaiky', pos: ['ZAG'], ovr: 83 },
      { name: 'Luiz Felipe', pos: ['ZAG'], ovr: 80 },
      { name: 'Wagner Leonardo', pos: ['ZAG'], ovr: 79 },
      { name: 'Sabino', pos: ['ZAG'], ovr: 77 },
      { name: 'Felipe Jonatan', pos: ['LE'], ovr: 80 },
      { name: 'Alison', pos: ['VOL'], ovr: 80 },
      { name: 'Jean Mota', pos: ['MEI', 'VOL'], ovr: 80 },
      { name: 'Gabriel Pirani', pos: ['MEI'], ovr: 84 },
      { name: 'Vinicius Balieiro', pos: ['MEI'], ovr: 79 },
      { name: 'Marcos Guilherme', pos: ['PD', 'MEI'], ovr: 82 },
      { name: 'Lucas Braga', pos: ['PE', 'ATA'], ovr: 83 },
      { name: 'Ângelo', pos: ['ATA', 'PD'], ovr: 85 },
      { name: 'Marinho', pos: ['ATA', 'PE'], ovr: 89 },
      { name: 'Kaio Jorge', pos: ['ATA'], ovr: 89 },
      { name: 'Marcos Leonardo', pos: ['ATA'], ovr: 84 },
      { name: 'Diego Tardelli', pos: ['ATA'], ovr: 76 },
    ]},
];
