...
const TEAMS = [
  ...
  },
  {
    ...
    colors: { p: '#003399', s: '#ffffff' },
    players: [
      { name: 'Ygor Vinhas', pos: ['GOL'], ovr: 76 },
      { name: 'Marcelinho', pos: ['LD', 'MD'], ovr: 74 },
      { name: 'Marllon', pos: ['ZAG'], ovr: 75 },
      { name: 'Kayky Almeida', pos: ['ZAG'], ovr: 74 },
      { name: 'Cantillo', pos: ['LE', 'ZAG'], ovr: 74 },
      { name: 'Freitas', pos: ['VOL'], ovr: 74 },
      { name: 'Patrick de Paula', pos: ['VOL', 'MC'], ovr: 76 },
      { name: 'Patrick', pos: ['MEI', 'MC'], ovr: 76 },
      { name: 'Dodo', pos: ['PD', 'PE'], ovr: 75 },
      { name: 'Diego Hernandez', pos: ['PE', 'MEI'], ovr: 75 },
      { name: 'Eduardo', pos: ['ATA'], ovr: 75 },
      { name: 'Yago Pikachu', pos: ['PD', 'LD'], ovr: 77 },
      { name: 'Alef Manga', pos: ['ATA', 'PE'], ovr: 76 },
      { name: 'Jaja', pos: ['PE', 'ATA'], ovr: 75 },
      { name: 'Vitor Bueno', pos: ['MEI', 'MC'], ovr: 76 },
      { name: 'Gabriel Taliari', pos: ['ATA'], ovr: 75 },
      { name: 'Leonel Picco', pos: ['MC', 'VOL'], ovr: 74 },
      { name: 'Giovanni Pavani', pos: ['MEI', 'MC'], ovr: 74 },
      { name: 'Braian Cufre', pos: ['LE'], ovr: 74 },
      { name: 'Panagiotis Tachtsidis', pos: ['VOL', 'MC'], ovr: 75 },
    ]
  },
  {
