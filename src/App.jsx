...
const TEAMS = [
  ...
  {
    id: 'flamengo2026', club: 'Flamengo', year: 2026, label: 'Flamengo 2026 (Campeao vigente)', coach: 'Filipe Luis',
    colors: { p: '#C8102E', s: '#000000' },
    players: [
