...
const TEAMS = [
  ...
  {
    id: 'cruzeiro2026', club: 'Cruzeiro', year: 2026, label: 'Cruzeiro 2026 (Projeto Pedro Lourenco)', coach: 'Leonardo Jardim',
    colors: { p: '#0033A0', s: '#ffffff' },
    players: [
      { name: 'Cassio', pos: ['GOL'], ovr: 82 },
      { name: 'Fagner', pos: ['LD', 'MD'], ovr: 76 },
      { name: 'Fabricio Bruno', pos: ['ZAG'], ovr: 84 },
      { name: 'Joao Marcelo', pos: ['ZAG'], ovr: 79 },
      { name: 'Kaiki', pos: ['LE', 'ME'], ovr: 77 },
      { name: 'Lucas Romero', pos: ['VOL'], ovr: 78 },
      { name: 'Lucas Silva', pos: ['MC', 'VOL'], ovr: 80 },
      { name: 'Christian', pos: ['MC', 'MEI'], ovr: 80 },
      { name: 'Matheus Pereira', pos: ['MEI', 'PD'], ovr: 86 },
      { name: 'Kaio Jorge', pos: ['ATA'], ovr: 84 },
      { name: 'Wanderson', pos: ['PE', 'ATA'], ovr: 80 },
      { name: 'Gabigol', pos: ['ATA'], ovr: 80 },
      { name: 'Sinisterra', pos: ['PE', 'PD'], ovr: 82 },
      { name: 'Walace', pos: ['VOL', 'MC'], ovr: 79 },
      { name: 'Marquinhos', pos: ['PD', 'PE'], ovr: 79 },
      { name: 'Eduardo', pos: ['VOL', 'MC'], ovr: 78 },
      { name: 'Villalba', pos: ['LE'], ovr: 77 },
      { name: 'Bolasie', pos: ['PE', 'ATA'], ovr: 75 },
      { name: 'Leo Aragao', pos: ['GOL'], ovr: 76 },
      { name: 'Matheus Henrique', pos: ['MC', 'VOL'], ovr: 79 },
    ]
  },
  {
  ...
  {
    id: 'vasco2026', club: 'Vasco', year: 2026, label: 'Vasco 2026 (Dinizismo em Sao Januario)', coach: 'Fernando Diniz',
    colors: { p: '#000000', s: '#ffffff' },
    players: [
      { name: 'Leo Jardim', pos: ['GOL'], ovr: 80 },
      { name: 'Puma Rodriguez', pos: ['LD', 'MD'], ovr: 74 },
      { name: 'Robert Renan', pos: ['ZAG', 'LE'], ovr: 77 },
      { name: 'Carlos Cuesta', pos: ['ZAG', 'LD', 'VOL'], ovr: 76 },
      { name: 'Lucas Piton', pos: ['LE', 'ME'], ovr: 76 },
      { name: 'Thiago Mendes', pos: ['VOL', 'MC', 'ZAG'], ovr: 76 },
      { name: 'Tche Tche', pos: ['VOL', 'MC', 'LD'], ovr: 75 },
      { name: 'Coutinho', pos: ['MEI', 'PE', 'MC'], ovr: 77 },
      { name: 'Andres Gomez', pos: ['PD', 'PE', 'ATA'], ovr: 78 },
      { name: 'David', pos: ['ATA', 'PE', 'PD'], ovr: 73 },
      { name: 'Nuno Moreira', pos: ['PE', 'MEI', 'PD', 'ME'], ovr: 76 },
      { name: 'Paulo Henrique', pos: ['LD', 'MD'], ovr: 73 },
      { name: 'Lucas Freitas', pos: ['ZAG', 'LE'], ovr: 71 },
      { name: 'Cuiabano', pos: ['LE', 'ME', 'PE'], ovr: 75 },
      { name: 'Cauan Barros', pos: ['VOL', 'MC'], ovr: 74 },
      { name: 'Mateus Carvalho', pos: ['VOL', 'MC'], ovr: 72 },
      { name: 'Johan Rojas', pos: ['MEI', 'PE', 'PD'], ovr: 74 },
      { name: 'Marino Hinestroza', pos: ['PD', 'MD', 'PE'], ovr: 74 },
      { name: 'Brenner', pos: ['ATA', 'PE'], ovr: 73 },
      { name: 'Claudio Spinelli', pos: ['ATA'], ovr: 72 },
    ]
  },
  {
