...
const TEAMS = [
  ...
  {
    id: 'corinthians2026', club: 'Corinthians', year: 2026, label: 'Corinthians 2026 (Memphis e Dorival)', coach: 'Dorival Junior',
    colors: { p: '#000000', s: '#ffffff' },
    players: [
      { name: 'Hugo Souza', pos: ['GOL'], ovr: 84 },
      { name: 'Matheuzinho', pos: ['LD', 'MD'], ovr: 78 },
      { name: 'Andre Ramalho', pos: ['ZAG'], ovr: 79 },
      { name: 'Gustavo Henrique', pos: ['ZAG'], ovr: 77 },
      { name: 'Matheus Bidu', pos: ['LE', 'ME'], ovr: 77 },
      { name: 'Jose Martinez', pos: ['VOL'], ovr: 78 },
      { name: 'Raniele', pos: ['VOL', 'MC'], ovr: 78 },
      { name: 'Rodrigo Garro', pos: ['MEI', 'MC'], ovr: 83 },
      { name: 'Memphis Depay', pos: ['ATA', 'MEI'], ovr: 86 },
      { name: 'Yuri Alberto', pos: ['ATA'], ovr: 84 },
      { name: 'Angel Romero', pos: ['PD', 'ATA'], ovr: 78 },
      { name: 'Caca', pos: ['ZAG'], ovr: 76 },
      { name: 'Felix Torres', pos: ['ZAG'], ovr: 77 },
      { name: 'Breno Bidon', pos: ['MC', 'VOL'], ovr: 77 },
      { name: 'Charles', pos: ['VOL', 'MC'], ovr: 76 },
      { name: 'Talles Magno', pos: ['PE', 'ATA'], ovr: 77 },
      { name: 'Vitinho', pos: ['PD', 'LD'], ovr: 77 },
      { name: 'Hugo', pos: ['LE'], ovr: 76 },
      { name: 'Matheus Donelli', pos: ['GOL'], ovr: 75 },
      { name: 'Kayke', pos: ['ATA'], ovr: 75 },
    ]
  },
  {
