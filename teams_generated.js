const TEAMS = [
  ...
  { id: 'santos1962', club: 'Santos', year: 1962, label: 'Santos 1962 (Libertadores + Mundial + Taca Brasil)', coach: 'Lula',
    ...
    players: [
      ...
      { name: 'Formiga', pos: ['ZAG','MC'], ovr: 77 },
  ...
  { id: 'fluminense1970', club: 'Fluminense', year: 1970, label: 'Fluminense 1970 (Taça de Prata)', coach: 'Paulo Amaral',
    ...
    players: [
      ...
      { name: 'Assis', pos: ['ZAG','MD'], ovr: 80 },
      { name: 'Marco Antonio', pos: ['LE','MC'], ovr: 84 },
  ...
  { id: 'atletico-mg1971', club: 'Atletico-MG', year: 1971, label: 'Atletico-MG 1971 (Campeao Brasileiro)', coach: 'Tele Santana',
    ...
    players: [
      ...
      { name: 'Dario', pos: ['MC'], ovr: 86 },
      { name: 'Tião', pos: ['PE','MC'], ovr: 79 },
  ...
  { id: 'flamengo1980', club: 'Flamengo', year: 1980, label: 'Flamengo 1980 (Campeao Brasileiro)', coach: 'Claudio Coutinho',
    ...
    players: [
      ...
      { name: 'Carlos Alberto', pos: ['LD','MC'], ovr: 81 },
      { name: 'Cantarele', pos: ['GOL'], ovr: 81 },
      { name: 'Vítor', pos: ['VOL','MC'], ovr: 80 },
      { name: 'Anselmo', pos: ['ATA'], ovr: 79 },
      { name: 'Lico', pos: ['PE','MD'], ovr: 78 },
    ]},
  { id: 'flamengo1981', club: 'Flamengo', year: 1981, label: 'Flamengo 1981 (Mundial)', coach: 'Paulo Cesar Carpegiani',
    ...
    players: [
      ...
      { name: 'Baroninho', pos: ['PE','MC'], ovr: 84 },
      { name: 'Chiquinho', pos: ['ATA','MC'], ovr: 83 },
      { name: 'Cantarele', pos: ['GOL'], ovr: 81 },
  ...
  { id: 'fluminense1984', club: 'Fluminense', year: 1984, label: 'Fluminense 1984 (Campeao Brasileiro)', coach: 'Carlos Alberto Parreira',
    ...
    players: [
      ...
      { name: 'Vica', pos: ['ZAG','MC'], ovr: 83 },
      { name: 'Renê', pos: ['MC','VOL'], ovr: 82 },
      { name: 'Paulinho', pos: ['ATA'], ovr: 81 },
      { name: 'Leomir', pos: ['MC','MC'], ovr: 81 },
      { name: 'Beto', pos: ['LD'], ovr: 80 },
      { name: 'Renato', pos: ['LE','MC'], ovr: 80 },
  ...
  { id: 'coritiba1985', club: 'Coritiba', year: 1985, label: 'Coritiba 1985 (Campeao Brasileiro)', coach: 'Enio Andrade',
    ...
    players: [
      ...
      { name: 'Marco Aurélio', pos: ['MC','MC'], ovr: 83 },
  ...
  { id: 'bahia1988', club: 'Bahia', year: 1988, label: 'Bahia 1988 (Bicampeão Brasileiro)', coach: 'Evaristo de Macedo',
    ...
    players: [
      ...
      { name: 'Marquinhos', pos: ['PD','ME'], ovr: 85 },
      { name: 'Tarantini', pos: ['LD'], ovr: 85 },
      { name: 'Paulo César', pos: ['LE'], ovr: 85 },
      { name: 'Sandro', pos: ['PE','MC'], ovr: 84 },
      { name: 'Gil Sergipano', pos: ['VOL','MC'], ovr: 84 },
      { name: 'Osmar', pos: ['ATA','MD'], ovr: 83 },
      { name: 'Deda', pos: ['MEI','MD'], ovr: 82 },
      { name: 'Newmar', pos: ['ZAG'], ovr: 81 },
      { name: 'Edinho', pos: ['LD','ME'], ovr: 81 },
      { name: 'Mailson', pos: ['LE'], ovr: 80 },
      { name: 'Sidmar', pos: ['GOL'], ovr: 80 },
      { name: 'Renato', pos: ['PD','MC'], ovr: 79 },
  ...
  { id: 'sao-paulo1991', club: 'Sao Paulo', year: 1991, label: 'São Paulo 1991 (Campeão Brasileiro)', coach: 'Tele Santana',
    ...
    players: [
      ...
      { name: 'Ronaldão', pos: ['ZAG','MC'], ovr: 87 },
      { name: 'Bernardo', pos: ['VOL','MC'], ovr: 86 },
  ...
  { id: 'palmeiras1993', club: 'Palmeiras', year: 1993, label: 'Palmeiras 1993 (Campeão Brasileiro)', coach: 'Vanderlei Luxemburgo',
    ...
    players: [
      ...
      { name: 'Amaral', pos: ['VOL','ME'], ovr: 82 },
      { name: 'Jean Carlo', pos: ['PE','MC'], ovr: 81 },
  ...
  { id: 'palmeiras1994', club: 'Palmeiras', year: 1994, label: 'Palmeiras 1994 (Bicampeão Brasileiro)', coach: 'Vanderlei Luxemburgo',
    ...
    players: [
      ...
      { name: 'Flávio Conceição', pos: ['MC','MC'], ovr: 87 },
  ...
  { id: 'gremio1996', club: 'Gremio', year: 1996, label: 'Gremio 1996', coach: 'Luiz Felipe Scolari',
    ...
    players: [
      ...
      { name: 'Roger', pos: ['LE','MC'], ovr: 79 },
      { name: 'Dinho', pos: ['VOL','MEI'], ovr: 79 },
      { name: 'Luis Carlos Goiano', pos: ['VOL','MC'], ovr: 78 },
      { name: 'Emerson', pos: ['MEI','VOL'], ovr: 82 },
      { name: 'Carlos Miguel', pos: ['MEI','MC'], ovr: 79 },
      ...
      { name: 'Arilson', pos: ['MEI','MC'], ovr: 73 },
      { name: 'Helio', pos: ['LD','MD'], ovr: 71 },
      { name: 'Marcelo', pos: ['PE','ME'], ovr: 71 },
      { name: 'Marcio', pos: ['GOL','MC'], ovr: 70 },
  ...
  { id: 'vasco1997', club: 'Vasco', year: 1997, label: 'Vasco 1997 (Brasileiro)', coach: 'Antonio Lopes',
    ...
    players: [
      ...
      { name: 'Juninho Pernambucano', pos: ['MEI','MD'], ovr: 85 },
      { name: 'Ramon', pos: ['MEI','MD'], ovr: 81 },
      { name: 'Edmundo', pos: ['ATA'], ovr: 95 },
      { name: 'Evair', pos: ['PE','ME'], ovr: 85 },
      { name: 'Marica', pos: ['LD'], ovr: 73 },
      { name: 'Alex Pinho', pos: ['ZAG'], ovr: 72 },
      { name: 'Pedrinho', pos: ['MEI','MC'], ovr: 77 },
      { name: 'Mauricinho', pos: ['MEI','MC'], ovr: 72 },
      { name: 'Donizete', pos: ['ATA'], ovr: 79 },
      { name: 'Brener', pos: ['ATA'], ovr: 73 },
      { name: 'Luizao', pos: ['ATA'], ovr: 80 },
      { name: 'Gil', pos: ['ZAG','MC'], ovr: 71 },
      { name: 'Sandro', pos: ['MEI','MC'], ovr: 70 },
    ]},
  ...
  { id: 'athletico-pr2001', club: 'Athletico-PR', year: 2001, label: 'Athletico-PR 2001', coach: 'Geninho',
    ...
    players: [
      ...
      { name: 'Cocito', pos: ['VOL','MC'], ovr: 78 },
      { name: 'Kleberson', pos: ['VOL','MEI'], ovr: 86 },
      { name: 'Adriano', pos: ['MEI','MC'], ovr: 79 },
      { name: 'Kleber', pos: ['ATA'], ovr: 84 },
      { name: 'Alex Mineiro', pos: ['ATA'], ovr: 85 },
      { name: 'Igor', pos: ['LD'], ovr: 73 },
      { name: 'Pires', pos: ['MEI','MC'], ovr: 72 },
      { name: 'Rodriguinho', pos: ['MEI','MC'], ovr: 71 },
      { name: 'Souza', pos: ['ATA','MC'], ovr: 74 },
      { name: 'Ilan', pos: ['ATA'], ovr: 73 },
      { name: 'Adauto', pos: ['ATA'], ovr: 72 },
      { name: 'Marcos', pos: ['ZAG','MD'], ovr: 71 },
  ...
  { id: 'santos2002', club: 'Santos', year: 2002, label: 'Santos 2002 (Meninos da Vila)', coach: 'Emerson Leao',
    ...
    players: [
      ...
      { name: 'Alex', pos: ['ZAG','MC'], ovr: 78 },
      { name: 'Leo', pos: ['LE'], ovr: 79 },
      { name: 'Paulo Almeida', pos: ['VOL','MC'], ovr: 77 },
      { name: 'Renato', pos: ['VOL','MC'], ovr: 78 },
      { name: 'Elano', pos: ['MEI','MD'], ovr: 84 },
      { name: 'Diego', pos: ['MEI','MC'], ovr: 85 },
      { name: 'Robinho', pos: ['ATA','ME'], ovr: 92 },
      { name: 'William', pos: ['PE','ME'], ovr: 76 },
      { name: 'Julio Cesar', pos: ['GOL','ME'], ovr: 73 },
      { name: 'Wellington', pos: ['MEI','MC'], ovr: 72 },
      { name: 'Alexandre', pos: ['ATA'], ovr: 73 },
      { name: 'Robert', pos: ['ATA'], ovr: 74 },
      { name: 'Michel', pos: ['ATA'], ovr: 71 },
      { name: 'Adriano', pos: ['ZAG','MC'], ovr: 73 },
  ...
  { id: 'santos2004', club: 'Santos', year: 2004, label: 'Santos 2004 (Bicampeonato + 103 gols)', coach: 'Vanderlei Luxemburgo',
    colors: { p: '#000000', s: '#ffffff' },
    players: [
      { name: 'Mauro', pos: ['GOL','ME'], ovr: 78 },
      { name: 'Flavio', pos: ['LD','MC'], ovr: 75 },
      ...
      { name: 'Elano', pos: ['MEI','MD'], ovr: 85 },
      { name: 'Robinho', pos: ['ATA','ME'], ovr: 91 },
      { name: 'Deivid', pos: ['ATA'], ovr: 84 },
      { name: 'Paulo Cesar', pos: ['LD'], ovr: 73 },
      { name: 'Marcinho', pos: ['MEI','MC'], ovr: 72 },
      { name: 'Basilio', pos: ['ATA'], ovr: 71 },
      { name: 'William', pos: ['ATA','ME'], ovr: 73 },
      { name: 'Adriano', pos: ['ZAG','MC'], ovr: 73 },
      { name: 'Rodrigo', pos: ['LD'], ovr: 71 },
      { name: 'Gabriel', pos: ['ZAG'], ovr: 72 },
      { name: 'Marquinhos', pos: ['VOL','ME'], ovr: 71 },
  ...
  { id: 'corinthians2005', club: 'Corinthians', year: 2005, label: 'Corinthians 2005', coach: 'Antonio Lopes',
    ...
    players: [
      ...
      { name: 'Marcelo Mattos', pos: ['VOL','MC'], ovr: 79 },
      { name: 'Bruno Octavio', pos: ['VOL','MEI'], ovr: 76 },
      { name: 'Carlos Alberto', pos: ['MEI','MC'], ovr: 81 },
      { name: 'Tevez', pos: ['ATA'], ovr: 93 },
      { name: 'Nilmar', pos: ['ATA'], ovr: 80 },
      { name: 'Julio Cesar', pos: ['GOL','ME'], ovr: 74 },
      { name: 'Sebastian Dominguez', pos: ['ZAG'], ovr: 76 },
      { name: 'Mascherano', pos: ['VOL','MC'], ovr: 86 },
      { name: 'Roger', pos: ['MEI','MC'], ovr: 78 },
      { name: 'Jo', pos: ['ATA'], ovr: 76 },
      { name: 'Wescley', pos: ['MEI','MC'], ovr: 72 },
      { name: 'Eduardo Ratinho', pos: ['MEI','MC'], ovr: 71 },
      { name: 'Rodrigo', pos: ['LD'], ovr: 71 },
      { name: 'Rosinei', pos: ['MEI','MC'], ovr: 77 },
    ]},
  ...
  { id: 'sao-paulo2007', club: 'Sao Paulo', year: 2007, label: 'Sao Paulo 2007 (Bicampeonato)', coach: 'Muricy Ramalho',
    ...
    players: [
      ...
      { name: 'Danilo', pos: ['MEI','MC'], ovr: 81 },
      { name: 'Hernanes', pos: ['MEI','MC'], ovr: 86 },
  ...
  { id: 'flamengo2009', club: 'Flamengo', year: 2009, label: 'Flamengo 2009 (Hexacampeonato)', coach: 'Andrade',
    ...
    players: [
      ...
      { name: 'Willians', pos: ['VOL','MC'], ovr: 80 },
      { name: 'Petkovic', pos: ['MEI','MC'], ovr: 85 },
      { name: 'Adriano', pos: ['ATA','MC'], ovr: 91 },
      ...
      { name: 'Fierro', pos: ['MEI','MC'], ovr: 75 },
      { name: 'Camacho', pos: ['ATA','MC'], ovr: 72 },
  ...
  { id: 'santos2011', club: 'Santos', year: 2011, label: 'Santos 2011 (Libertadores)', coach: 'Adilson Batista',
    ...
    players: [
      ...
      { name: 'Marquinhos', pos: ['VOL','ME'], ovr: 78 },
    ]},
  { id: 'corinthians2011', club: 'Corinthians', year: 2011, label: 'Corinthians 2011 (Pentacampeonato)', coach: 'Tite',
    ...
    players: [
      ...
      { name: 'Emerson Sheik', pos: ['ATA','ME'], ovr: 85 },
      { name: 'Jorge Henrique', pos: ['PD','MD'], ovr: 80 },
      { name: 'Liedson', pos: ['ATA'], ovr: 82 },
      { name: 'Willian', pos: ['PD','ME'], ovr: 84 },
      { name: 'Adriano', pos: ['ATA','MC'], ovr: 80 },
      { name: 'Romarinho', pos: ['ATA'], ovr: 78 },
      { name: 'Paulo Andre', pos: ['ZAG'], ovr: 80 },
      { name: 'Julio Cesar', pos: ['GOL','ME'], ovr: 80 },
      { name: 'Douglas', pos: ['MEI','MC'], ovr: 74 },
  ...
  { id: 'atletico-mg2013', club: 'Atletico-MG', year: 2013, label: 'Atletico-MG 2013 (Libertadores)', coach: 'Cuca',
    ...
    players: [
      ...
      { name: 'Richarlyson', pos: ['LE','MC'], ovr: 82 },
      { name: 'Pierre', pos: ['VOL','MC'], ovr: 85 },
      { name: 'Josue', pos: ['VOL','MEI'], ovr: 82 },
      { name: 'Ronaldinho Gaucho', pos: ['MEI','MC'], ovr: 91 },
      ...
      { name: 'Rafael Carioca', pos: ['VOL','MC'], ovr: 79 },
  ...
  { id: 'cruzeiro2013', club: 'Cruzeiro', year: 2013, label: 'Cruzeiro 2013 (Brasileiro)', coach: 'Marcelo Oliveira',
    ...
    players: [
      ...
      { name: 'Willian', pos: ['ATA','ME'], ovr: 84 },
      { name: 'Julio Baptista', pos: ['MEI','MC'], ovr: 79 },
  ...
  { id: 'cruzeiro2014', club: 'Cruzeiro', year: 2014, label: 'Cruzeiro 2014 (Tetracampeonato)', coach: 'Marcelo Oliveira',
    ...
    players: [
      ...
      { name: 'Henrique', pos: ['VOL','MC'], ovr: 81 },
      { name: 'Nilton', pos: ['VOL','MC'], ovr: 83 },
      { name: 'Everton Ribeiro', pos: ['MEI','MD'], ovr: 90 },
      { name: 'Ricardo Goulart', pos: ['MEI','ATA'], ovr: 89 },
      { name: 'Marcelo Moreno', pos: ['ATA'], ovr: 85 },
      { name: 'Willian', pos: ['ATA','ME'], ovr: 83 },
      { name: 'Borges', pos: ['ATA'], ovr: 79 },
      ...
      { name: 'Bruno Ramires', pos: ['VOL','MC'], ovr: 79 },
    ]},
  ...
  { id: 'corinthians2017', club: 'Corinthians', year: 2017, label: 'Corinthians 2017 (Heptacampeonato)', coach: 'Fabio Carille',
    ...
    players: [
      ...
      { name: 'Guilherme Arana', pos: ['LE'], ovr: 83 },
      { name: 'Ralf', pos: ['VOL','MC'], ovr: 84 },
      { name: 'Maycon', pos: ['VOL','MC'], ovr: 85 },
      { name: 'Jadson', pos: ['MEI','MC'], ovr: 89 },
      { name: 'Marlone', pos: ['MEI','MC'], ovr: 82 },
      { name: 'Jo', pos: ['ATA'], ovr: 87 },
      { name: 'Romero', pos: ['PD','ATA'], ovr: 82 },
      { name: 'Malcom', pos: ['PD','MD'], ovr: 84 },
      { name: 'Marquinhos Gabriel', pos: ['PD','MD'], ovr: 80 },
      { name: 'Rodriguinho', pos: ['MEI','MC'], ovr: 84 },
      { name: 'Kazim', pos: ['ATA'], ovr: 73 },
      { name: 'Leo Santos', pos: ['ZAG'], ovr: 78 },
      { name: 'Camacho', pos: ['MEI','MC'], ovr: 74 },
  ...
  { id: 'flamengo2019', club: 'Flamengo', year: 2019, label: 'Flamengo 2019 (Bicampeonato + Libertadores)', coach: 'Jorge Jesus',
    ...
    players: [
      ...
      { name: 'Bruno Henrique', pos: ['PE','ME'], ovr: 90 },
      ...
      { name: 'Reinier', pos: ['MEI','MC'], ovr: 82 },
      { name: 'Michael', pos: ['ATA','MD'], ovr: 82 },
  ...
  { id: 'palmeiras2023', club: 'Palmeiras', year: 2023, label: 'Palmeiras 2023 (Tricampeonato com Abel)', coach: 'Abel Ferreira',
    ...
    players: [
      ...
      { name: 'Piquerez', pos: ['LE'], ovr: 89 },
      { name: 'Danilo', pos: ['VOL','MC'], ovr: 88 },
      { name: 'Ze Rafael', pos: ['VOL','MC'], ovr: 85 },
      { name: 'Gabriel Menino', pos: ['VOL','MC'], ovr: 83 },
      { name: 'Raphael Veiga', pos: ['MEI','MC'], ovr: 92 },
      { name: 'Estevao', pos: ['PD','MD'], ovr: 89 },
      { name: 'Flaco Lopez', pos: ['ATA'], ovr: 90 },
      { name: 'Dudu', pos: ['PD','MD'], ovr: 87 },
      { name: 'Rony', pos: ['PE','ME'], ovr: 84 },
      { name: 'Endrick', pos: ['ATA'], ovr: 93 },
      { name: 'Mayke', pos: ['LD'], ovr: 80 },
      { name: 'Vanderlan', pos: ['LE'], ovr: 79 },
      { name: 'Atuesta', pos: ['VOL','MC'], ovr: 80 },
      { name: 'Jhon Jhon', pos: ['MEI','MC'], ovr: 82 },
  ...
  { id: 'santos2015', club: 'Santos', year: 2015, label: 'Santos 2015 (Paulistao + Vice Copa BR)', coach: 'Dorival Junior',
    ...
    players: [
      ...
      { name: 'Renato', pos: ['VOL','MC'], ovr: 82 },
      { name: 'Thiago Maia', pos: ['VOL','MC'], ovr: 85 },
      { name: 'Lucas Lima', pos: ['MEI','MC'], ovr: 87 },
      { name: 'Marquinhos Gabriel', pos: ['PD','MD'], ovr: 82 },
      ...
      { name: 'Geuvânio', pos: ['PE','ME'], ovr: 80 },
      { name: 'Robinho', pos: ['ATA','ME'], ovr: 81 },
      { name: 'Elano', pos: ['MEI','MD'], ovr: 79 },
      { name: 'Leo Cittadini', pos: ['MEI','MC'], ovr: 77 },
      { name: 'Alison', pos: ['VOL','MC'], ovr: 77 },
    ]},
  { id: 'santos2020', club: 'Santos', year: 2020, label: 'Santos 2020 (Vice-Campeao da Libertadores)', coach: 'Cuca',
    ...
    players: [
      ...
      { name: 'Alison', pos: ['VOL','MC'], ovr: 79 },
      { name: 'Diego Pituca', pos: ['MC','VOL'], ovr: 81 },
      { name: 'Marinho', pos: ['PD','MD'], ovr: 85 },
      { name: 'Soteldo', pos: ['PE','ME'], ovr: 84 },
      { name: 'Lucas Braga', pos: ['PE','ME'], ovr: 77 },
  ...
  { id: 'botafogo2023', club: 'Botafogo', year: 2023, label: 'Botafogo 2023 (Deixou escapar)', coach: 'Luis Castro',
    ...
    players: [
      ...
      { name: 'Eduardo', pos: ['VOL','ME'], ovr: 83 },
