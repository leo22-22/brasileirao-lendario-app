const TEAMS = [
  { id: 'bahia1959', club: 'Bahia', year: 1959, label: 'Bahia 1959 (1o Campeonato Nacional)', coach: 'Carlos Volante',
    ...
    players: [
      ...
      { name: 'Marito', pos: ['PD'], ovr: 86 },
      { name: 'Florisvaldo', pos: ['LD','ZAG'], ovr: 76 },
      { name: 'Bacamarte', pos: ['ZAG'], ovr: 75 },
      { name: 'Beto', pos: ['MC','VOL'], ovr: 81 },
      { name: 'Bombeiro', pos: ['MC'], ovr: 78 },
      { name: 'Ari', pos: ['MEI'], ovr: 77 },
      { name: 'Biriba', pos: ['PE'], ovr: 84 },
  ...
  { id: 'palmeiras1993', club: 'Palmeiras', year: 1993, label: 'Palmeiras 1993 (Campeão Brasileiro)', coach: 'Vanderlei Luxemburgo',
    ...
    players: [
      ...
      { name: 'Jean Carlo', pos: ['PE'], ovr: 81 },
      { name: 'Velloso', pos: ['GOL'], ovr: 80 },
      { name: 'Ricardo', pos: ['LE'], ovr: 79 },
      { name: 'Juary', pos: ['MC'], ovr: 78 },
    ]},
